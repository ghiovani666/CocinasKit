...
$("body").append('<div class="fixed-button active"><a href="javascript:void(0)"  class="btn btn-md btn-primary"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Chat</a> </div>');var $window=$(window),nav=$(".fixed-button");
