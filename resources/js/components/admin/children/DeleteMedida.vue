<template>
  <v-row justify="center">
    <v-dialog persistent v-model="dialogDeleteMedida" max-width="400">
      <v-card>
        <v-card-title class="headline">Eliminar Medida</v-card-title>
...
<script>
export default {
  props: ["dialogDeleteMedida", "authUser", "id_medida"],
  data() {
    return {
      config: {
        headers: {
