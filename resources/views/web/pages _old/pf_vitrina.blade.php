...
<div class="product_attributes clearfix margin-bottom-10">
    ...
    <div id="attributes">
        ...
        <fieldset class="attribute_fieldset" style="height: <?php echo $resultado =((($Products[0]->id_cat==5 || $Products[0]->id_cat==6 || $Products[0]->id_cat==7 )?270:($Products[0]->id_cat==8 || $Products[0]->id_cat==9 || $Products[0]->id_cat==10 || $Products[0]->id_cat==16 ))?270:370); ?>px;">
