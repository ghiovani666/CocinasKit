                            ...
                            <div class="col-sm-3">
                                ...
                                <li class="item box_shadom_imagen  margin-bottom-30">
                                    <div class="product-img">
                                        <a href="{{url('/composicion_oferta_detalle')}}/{{$product->id}}"><img
                                                class="full-width img-responsive" src="<?php echo $product->url_image; ?>"
                                                alt=""></a>
                                        <a class="product-review"
                                            href="{{url('/composicion_oferta_detalle')}}/{{$product->id}}">Mas Información</a>
                                    </div>
                                    <div class="product-description product-description-brd" style="background: white;">
                                        <div class="overflow-h margin-bottom-5">
                                            <div class="pull-left">
                                                <h4 class="title-price"><a
                                                        href="{{url('/composicion_oferta_detalle')}}/{{$product->id}}"><?php echo $product->pro_name; ?></a>
                                                </h4>
                                                <span class="gender">
                                        ...
                                        <ul class="list-inline product-ratings">
                                            ...
                                            <h2 id="price">
                                                <!-- <img src="{{ URL::asset('theme/images/shop/sale.png') }}" style="width:60px" /> -->
                                                <span style="text-decoration:line-through; color:#ddd"></span> 
                                                ${{$product->price}} 
                                            </h2>

                                            <a href="{{url('/composicion_oferta_detalle')}}/{{$product->id}}">
                                                <button class="btn btn-success add-to-cart"
                                                    id="cartBtn<?php echo $countP;?>">MÁS</button>
                                            </a>
                                            ...
                                            // $wishData = DB::table('wishlist')->leftJoin('products', 'wishlist.pro_id', '=', 'products.id')->where('wishlist.pro_id', '=',$product->id)->get();
                                                ...
                                                <form action="{{url('/lista_deseo_agregar')}}" method="post">
                                                    ...
                                                    <input type="hidden" value="{{$product->price}}" name="precio" />
                                                    <input type="hidden" value="{{$product->url_image}}" name="url_image" />
                                                    <button type="submit" style="background: #13756f"
                                                        class="btn btn-primary btn-lg btn-block" id="addToCart2"><i
                                                            class="fa fa-heart-o" aria-hidden="true"></i>
                                                        Añadir a la Lista de Deseos
                                                    </button>
                                                </form>
                                                <?php } else {?>
                                                <a style="background: #13756f" class="btn btn-primary btn-lg btn-block"
                                                    href="{{url('/lista_deseo')}}"><i class="fa fa-heart-o"
                                                        aria-hidden="true"></i>
                                                    Se añadio a lista de Deseos</a>
                                                <?php }}else{?>
                                                <a style="background: #13756f" class="btn btn-primary btn-lg btn-block"
                                                    href="/login_register"><i class="fa fa-heart-o"
                                                        aria-hidden="true"></i>
