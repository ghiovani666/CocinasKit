        ...
        <form id="form1" action="{{url('/')}}/checkout" method="get">
            <div class="promoCode">
                ...
                <div class="form-check" style="display: flex;">
                    <input class="form-check-input" style="margin-right: 12px;" type="radio" value="1" name="txt_pago_1"
                        required>
                ...
                <div class="form-check" style="display: flex;">
                    <input class="form-check-input" style="margin-right: 12px;" type="radio" value="3" name="txt_pago_2"
                        required>
                    <label class="form-check-label" for="txt_pago_2"> Recoger de Forma Personal
                    </label>
                    <input class="form-check-input" style="margin-right: 12px;" type="radio" value="4"
                        name="txt_pago_2">
                    <label class="form-check-label" for="txt_pago_2"> Deseo enviar por Delivery : 70
                        Euros
                    </label>
                </div>
