...
class CartController extends Controller
{
    ...
    public function addItem(Request $request,$id){
            ...
            $detalleProducto=[
              "id_product"              => $request->id_producto_id_item,// id del producto
       ...
       // Cart::add($id,$products->pro_name,2,$price,['datos'=>$datas,'img' => $products->pro_img,'stock' => $products->stock]);
        Cart::add($id,$products[0]->pro_name,$cantidad,$costo_total,$products[0]->id_item,['datos'=>$detalleProducto,'id_imagen' => $request->id_imagens,'img' => $products[0]->url_image]);
