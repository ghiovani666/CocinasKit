...
class MuebleCompletoController extends Controller {
 ...
 {        
  ...
  {        
    ...
    $arrays_id_colores  = $request->id_colores;

    var_dump($arrays_id_colores);
  ...
  try {
      //  :::::::::::::::::::: 1: COLORES :::::::::::::::::::::::::::::::
      DB::table('md_modelo_puerta_color_intermedio')->where('id_producto', '=', $request->id_producto)->delete();

            DB::table('md_modelo_puerta_color_intermedio')->insert([
              'id_producto'       => $id_producto,
              'id_modelo_puerta'  => $id_producto,
              'id_color'          => $arrays_id_colores]);
