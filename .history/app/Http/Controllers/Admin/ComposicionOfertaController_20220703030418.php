          ...
          case 'ACTUALIZAR': 
            ...
            case 'ELIMINAR': 
              ...
              try {
                  ...
                  DB::table('mc_colores_intermedio')->where('id_producto', '=', 366)->delete();
                  DB::table('mc_tirador_intermedio')->where('id_producto', '=', 366)->delete();
                  DB::table('mc_enzimera_intermedio')->where('id_producto', '=', 366)->delete();
