...
class MuebleCompletoController extends Controller {
    ...
    public function mueble_completo() {
      ...
      $cbCategoria = DB::select("SELECT * FROM menu_category M  WHERE M.id_menu=4 AND M.id_cat NOT IN (19) ORDER BY M.id_cat asc");
            ...
            try {
                ...
                if($file1 != NULL &&  $id_imagen_1 != NULL){
                  ...
                  if(file_exists(str_replace('/img/', 'img/',  $url_imagen[0]->url_image))){
                    ...
                    if($file1 != NULL){
                      $filename1  =  time() .'_'.$file1->getClientOriginalName();
                      $path1 = "img/mc_mueble_completo/".$request->id_producto;
                      $file1->move($path1,$filename1);
      
                      DB::table('imagen')->insert([
                          'id_product'  =>  $request->id_producto, 
                          'url_image'   => '/img/mc_mueble_completo/'.$request->id_producto.'/'.$filename1, 
                          'created_at'  =>  date("Y-m-d H:i:s"),
                          'updated_at'  =>  date("Y-m-d H:i:s")
                        ]);
                    }
                  ...
                  if($file2 != NULL &&  $id_imagen_2 != NULL){
                    ...
                    if(file_exists(str_replace('/img/', 'img/',  $url_imagen[0]->url_image))){
                      ...
                      $result  =  DB::table('imagen')
                        ...
                        if($file2 != NULL){
                          $filename2  =  time() .'_'.$file2->getClientOriginalName();
                          $path2 = "img/mc_mueble_completo/".$request->id_producto;
                          $file2->move($path2,$filename2);
          
                          DB::table('imagen')->insert([
                              'id_product'  =>  $request->id_producto, 
                              'url_image'   => '/img/mc_mueble_completo/'.$request->id_producto.'/'.$filename2, 
                              'created_at'  =>  date("Y-m-d H:i:s"),
                              'updated_at'  =>  date("Y-m-d H:i:s")
                            ]);
                        }
                    ...
                    if($file3 != NULL &&  $id_imagen_3 != NULL){
                      ...
                      if(file_exists(str_replace('/img/', 'img/',  $url_imagen[0]->url_image))){
                        ...
                        $result  =  DB::table('imagen')
                          ...
                          if($file3 != NULL){
                            $filename3  =  time() .'_'.$file3->getClientOriginalName();
                            $path3 = "img/mc_mueble_completo/".$request->id_producto;
                            $file3->move($path3,$filename3);
            
                            DB::table('imagen')->insert([
                                'id_product'  =>  $request->id_producto, 
                                'url_image'   => '/img/mc_mueble_completo/'.$request->id_producto.'/'.$filename3, 
                                'created_at'  =>  date("Y-m-d H:i:s"),
                                'updated_at'  =>  date("Y-m-d H:i:s")
                              ]);
                          }
                      ...
                      if($file4 != NULL &&  $id_imagen_4 != NULL){
                        ...
                        if(file_exists(str_replace('/img/', 'img/',  $url_imagen[0]->url_image))){
                          ...
                          $result  =  DB::table('imagen')
                            ...
                            if($file4 != NULL){
                              $filename4  =  time() .'_'.$file4->getClientOriginalName();
                              $path4 = "img/mc_mueble_completo/".$request->id_producto;
                              $file4->move($path4,$filename4);
              
                              DB::table('imagen')->insert([
                                  'id_product'  =>  $request->id_producto, 
                                  'url_image'   => '/img/mc_mueble_completo/'.$request->id_producto.'/'.$filename4, 
                                  'created_at'  =>  date("Y-m-d H:i:s"),
                                  'updated_at'  =>  date("Y-m-d H:i:s")
                                ]);
                            }
                        ...
                        if($file5 != NULL &&  $id_imagen_5 != NULL){
                          ...
                          if(file_exists(str_replace('/img/', 'img/',  $url_imagen[0]->url_image))){
                            ...
                            $result  =  DB::table('imagen')
                              ...
                              if($file5 != NULL){
                                $filename5  =  time() .'_'.$file5->getClientOriginalName();
                                $path5 = "img/mc_mueble_completo/".$request->id_producto;
                                $file5->move($path5,$filename5);
                
                                DB::table('imagen')->insert([
                                    'id_product'  =>  $request->id_producto, 
                                    'url_image'   => '/img/mc_mueble_completo/'.$request->id_producto.'/'.$filename5, 
                                    'created_at'  =>  date("Y-m-d H:i:s"),
                                    'updated_at'  =>  date("Y-m-d H:i:s")
                                  ]);
                              }
