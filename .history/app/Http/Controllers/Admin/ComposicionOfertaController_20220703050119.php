...
class ComposicionOfertaController extends Controller {
    ...
    public function composicion_oferta_listar(Request $request) {
      ...
      return view('admin.pages.composicion_oferta.ajax.tablaProducto')->with(compact('rowData_')).view('admin.pages.composicion_oferta.admin_composicion_oferta')->with(compact('rowData_'));
    }
