...
class MuebleColoresController extends Controller {
    ...
    public function mueble_colores_listar_combobox(Request $request) {
      ...
      return view('admin.pages.mueble_colores.ajax.opcionesComboBox')
              ...
              $id_producto = DB::table('products')->insertGetId([
               ...
               DB::table('menu_items')->where('id_item', '43')->update(['numbers' => $count]);
                ...
                if($file0 != NULL){
                  ...
                  $path = "img/mc_mueble_colores/".$id_producto;
                  $file0->move($path,$filename);
  
                  $id_imagen__ = DB::table('imagen')->insertGetId([
                      'id_product' =>$id_producto, 
                      'url_image' => '/img/mc_mueble_colores/'.$id_producto.'/'.$filename, 
                      'created_at' => date("Y-m-d H:i:s"),
                      'updated_at' =>date("Y-m-d H:i:s")
                    ]);
                }
                ...
                if($file1 != NULL){
                  ...
                  $path1 = "img/mc_mueble_colores/".$id_producto;
                  $file1->move($path1,$filename1);
  
                  $result = DB::table('imagen')->insert([
                      'id_product' =>$id_producto, 
                      'url_image' => '/img/mc_mueble_colores/'.$id_producto.'/'.$filename1, 
                      'created_at' => date("Y-m-d H:i:s"),
                      'updated_at' =>date("Y-m-d H:i:s")
                    ]);
                }
                ...
                if($file2 != NULL){
                  ...
                  $path2 = "img/mc_mueble_colores/".$id_producto;
                  $file2->move($path2,$filename2);
  
                  $result = DB::table('imagen')->insert([
                      'id_product' =>$id_producto, 
                      'url_image' => '/img/mc_mueble_colores/'.$id_producto.'/'.$filename2, 
                      'created_at' => date("Y-m-d H:i:s"),
                      'updated_at' =>date("Y-m-d H:i:s")
                    ]);
                }
                ...
                if($file3 != NULL){
                  ...
                  $path3 = "img/mc_mueble_colores/".$id_producto;
                  $file3->move($path3,$filename3);
  
                  $result = DB::table('imagen')->insert([
                      'id_product' =>$id_producto, 
                      'url_image' => '/img/mc_mueble_colores/'.$id_producto.'/'.$filename3, 
                      'created_at' => date("Y-m-d H:i:s"),
                      'updated_at' =>date("Y-m-d H:i:s")
                    ]);
                }
                ...
                if($file4 != NULL){
                  ...
                  $path4 = "img/mc_mueble_colores/".$id_producto;
                  $file4->move($path4,$filename4);
  
                  $result = DB::table('imagen')->insert([
                      'id_product' =>$id_producto, 
                      'url_image' => '/img/mc_mueble_colores/'.$id_producto.'/'.$filename4, 
                      'created_at' => date("Y-m-d H:i:s"),
                      'updated_at' =>date("Y-m-d H:i:s")
                    ]);
                }
                ...
                if($file5 != NULL){
                  ...
                  $path5 = "img/mc_mueble_colores/".$id_producto;
                  $file5->move($path5,$filename5);
  
                  $result = DB::table('imagen')->insert([
                      'id_product' =>$id_producto, 
                      'url_image' => '/img/mc_mueble_colores/'.$id_producto.'/'.$filename5, 
                      'created_at' => date("Y-m-d H:i:s"),
                      'updated_at' =>date("Y-m-d H:i:s")
                    ]);
                }
