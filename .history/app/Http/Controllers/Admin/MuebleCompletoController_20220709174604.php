...
class MuebleCompletoController extends Controller {
 ...
 {        
    ...
    public function listar_medidas(Request $request) 
    {        
     $rowData_ = DB::select("
          SELECT
    ...
    {        
      ...
      var_dump($check_izquierda);
      var_dump($check_derecha);
      var_dump($check_doble);

      var_dump($txt_precio);

      var_dump($txt_id_imagen_);

      exit;


      INSERT INTO `cocina_kits`.`medida` (`id_medida`, `id_imagen`, `ancho`, `alto`, `fondo`, `largo`, `unidad_ancho`, `unidad_alto`, 
      `unidad_fondo`, `unidad_largo`, `price`, `desc_price`, `aume_price`, `id_color`, `apertura`, `id_tirador`, `apert_derecha`,
       `apert_izquierda`, `apert_doble`, `apert_abatible`, `apert_extraible`, `copete`, `created_at`, `updated_at`) VALUES ('1591', '79', '12', '74', '58', '0', 'cm', 'cm', 'cm', 'cm', '999', '0', '0', NULL, '0', '0', '0', '0', '0', '0', '0', '0', '2021-05-01 21:48:29', '2021-05-01 22:03:10');
