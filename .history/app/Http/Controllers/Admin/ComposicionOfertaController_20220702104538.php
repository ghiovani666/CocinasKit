          ...
          case 'ACTUALIZAR': 
                ...
                if($file0 != NULL){
                  ...
                  if(file_exists(str_replace('/img/', 'img/',  $url_imagen[0]->url_image))){
                    ...
                    $path = "img/mc_composicion_oferta/".$request->txt_id_menu;
                    ...
                    $result  =  DB::table('web_producto_galeria')
                      ...
                      ->update([
                        ...
                        'descripcion' => $request->txt_descripcion,
                        'url_link' => $request->txt_url_link,
                        'url_image' => '/img/mc_composicion_oferta/'.$request->txt_id_menu.'/'.$filename, 
                        'updated_at' =>date("Y-m-d H:i:s")
                        
                      ]); 
     
                      return json_encode(['data' => 'Actualizado el registro correctamente!','state' => 'ok','src' => '/img/mc_composicion_oferta/'.$request->txt_id_menu.'/'.$filename]);
