...
class MuebleCompletoController extends Controller {
 ...
 {        
  ...
  public function mueble_puertas_listar_(Request $request) {
    ...
    $rowData_ = DB::select("SELECT `id` , `nombre`, `url_image` FROM mc_modelo_puerta mp INNER JOIN mc_modelo_puerta_intermedio mps ON mp.id = mps.id_modelo_puerta
