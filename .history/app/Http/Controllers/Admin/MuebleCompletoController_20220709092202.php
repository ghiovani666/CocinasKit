            ...
            try {
              ...
              $id_producto = DB::table('products')->insertGetId([
               ...
               DB::table('menu_items')->where('id_item', $txt_id_item)->update(['numbers' => $count]);
                ...
                // $cbTirador = DB::select("SELECT * FROM mc_tirador M");
                // $cbModelo = DB::select("SELECT * FROM mc_modelo_puerta M ");
                // $cbTiradorUnero = DB::select("SELECT * FROM mc_tirador_unero M ");

                      //  :::::::::::::::::::: 1: COLORES :::::::::::::::::::::::::::::::
                      if($arraysCheck_1 != NULL){
                          $cbColores = DB::select("SELECT * FROM mc_colores M");
                          foreach ($cbColores as $value) {
                              DB::table('mc_colores_intermedio')->insert(['id_producto' => $id_producto,'id_color' => $value['id_color']]);
                            }
                      }else{
