...
class MuebleColorRegletaController  extends Controller {

    //:::::::::::::::::::::::::: CRUD COMPOSICION OFERTA::::::::::::::::::::::::::

    public function mueble_regleta() {
      return view('admin.pages.mueble_regleta.admin_mueble_regleta');
    }


    
    public function mueble_regleta_listar(Request $request) {    

        $rowData_ = DB::select("
        SELECT 
        mc.id, mc.url_image, mc.name_color, mc.description,pm.nombre
                          FROM mc_colores mc INNER JOIN mc_modelo_puerta pm on mc.id_modelo_puerta=pm.id
                          ORDER BY mc.id desc");

      return view('admin.pages.mueble_regleta.ajax.tablaProducto')->with(compact('rowData_'));
    }
 ...
 public function mueble_regleta_crear(Request $request) 
 {        
        ...
        $txt_id_modelo_puerta       = $request->txt_id_modelo_puerta;
          ...
          case 'CREAR': 
            ...
            try {
              ...
              if($file0 != NULL){
                  ...
                  $path = "img/mc_mueble_regleta";
                  $file0->move($path,$filename);
               
                  DB::table('mc_colores')->insert([
                    'name_color'          => $txt_pro_name, 
                    'description'         => $txt_descripcion, 
                    'id_modelo_puerta'    => $txt_id_modelo_puerta, 
                    'url_image' => '/img/mc_mueble_regleta/'.$filename, 
    ...
    public function mueble_regleta_editar(Request $request) {
