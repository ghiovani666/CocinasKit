...
class DescuentoUsuarioController extends Controller {
    ...
    public function descuento_usuario_listar_combobox(Request $request) {
      ...
      return view('admin.pages.descuento_usuario.ajax.opcionesComboBox')
              ...
              $id_producto = DB::table('products')->insertGetId([
               ...
               DB::table('menu_items')->where('id_item', '43')->update(['numbers' => $count]);
                ...
                if($file0 != NULL){
                  ...
                  $path = "img/mc_descuento_usuario/".$id_producto;
                  $file0->move($path,$filename);
  
                  $id_imagen__ = DB::table('imagen')->insertGetId([
                      'id_product' =>$id_producto, 
                      'url_image' => '/img/mc_descuento_usuario/'.$id_producto.'/'.$filename, 
                      'created_at' => date("Y-m-d H:i:s"),
                      'updated_at' =>date("Y-m-d H:i:s")
                    ]);
                }
                ...
                if($file1 != NULL){
                  ...
                  $path1 = "img/mc_descuento_usuario/".$id_producto;
                  $file1->move($path1,$filename1);
  
                  $result = DB::table('imagen')->insert([
                      'id_product' =>$id_producto, 
                      'url_image' => '/img/mc_descuento_usuario/'.$id_producto.'/'.$filename1, 
                      'created_at' => date("Y-m-d H:i:s"),
                      'updated_at' =>date("Y-m-d H:i:s")
                    ]);
                }
                ...
                if($file2 != NULL){
                  ...
                  $path2 = "img/mc_descuento_usuario/".$id_producto;
                  $file2->move($path2,$filename2);
  
                  $result = DB::table('imagen')->insert([
                      'id_product' =>$id_producto, 
                      'url_image' => '/img/mc_descuento_usuario/'.$id_producto.'/'.$filename2, 
                      'created_at' => date("Y-m-d H:i:s"),
                      'updated_at' =>date("Y-m-d H:i:s")
                    ]);
                }
                ...
                if($file3 != NULL){
                  ...
                  $path3 = "img/mc_descuento_usuario/".$id_producto;
                  $file3->move($path3,$filename3);
  
                  $result = DB::table('imagen')->insert([
                      'id_product' =>$id_producto, 
                      'url_image' => '/img/mc_descuento_usuario/'.$id_producto.'/'.$filename3, 
                      'created_at' => date("Y-m-d H:i:s"),
                      'updated_at' =>date("Y-m-d H:i:s")
                    ]);
                }
                ...
                if($file4 != NULL){
                  ...
                  $path4 = "img/mc_descuento_usuario/".$id_producto;
                  $file4->move($path4,$filename4);
  
                  $result = DB::table('imagen')->insert([
                      'id_product' =>$id_producto, 
                      'url_image' => '/img/mc_descuento_usuario/'.$id_producto.'/'.$filename4, 
                      'created_at' => date("Y-m-d H:i:s"),
                      'updated_at' =>date("Y-m-d H:i:s")
                    ]);
                }
                ...
                if($file5 != NULL){
                  ...
                  $path5 = "img/mc_descuento_usuario/".$id_producto;
                  $file5->move($path5,$filename5);
  
                  $result = DB::table('imagen')->insert([
                      'id_product' =>$id_producto, 
                      'url_image' => '/img/mc_descuento_usuario/'.$id_producto.'/'.$filename5, 
                      'created_at' => date("Y-m-d H:i:s"),
                      'updated_at' =>date("Y-m-d H:i:s")
                    ]);
                }
          ...
          case 'ACTUALIZAR': 
                ...
                if($file0 != NULL &&  $id_imagen_0 != NULL){
                  $url_imagen =  DB::table('imagen')->where('id_imagen', '=', $id_imagen_0)->get();
                    ...
                    $filename  =  time() .'_'.$file0->getClientOriginalName(); 
                    $path = "img/mc_descuento_usuario/".$request->id_producto;
                    $file0->move($path,$filename); 
      
                    $result  =  DB::table('imagen')
                      ->where("id_imagen",$id_imagen_0)
                      ->update([
                        'url_image' => '/img/mc_descuento_usuario/'.$request->id_producto.'/'.$filename, 
                        'updated_at' =>date("Y-m-d H:i:s")
                      ]); 
     
                     // return json_encode(['data' => 'Actualizado el registro correctamente!','state' => 'ok','src0' => '/img/mc_descuento_usuario/'.$request->id_producto.'/'.$filename]);
                  ...
                  if($file1 != NULL &&  $id_imagen_1 != NULL){
                    ...
                    if(file_exists(str_replace('/img/', 'img/',  $url_imagen[0]->url_image))){
                      ...
                      ->where("id_imagen",$id_imagen_1)
                       ...
                       // return json_encode(['data' => 'Actualizado el registro correctamente!','state' => 'ok','src1' => '/img/mc_descuento_usuario/'.$request->id_producto.'/'.$filename]);
                    ...
                    if($file2 != NULL &&  $id_imagen_2 != NULL){
                      ...
                      if(file_exists(str_replace('/img/', 'img/',  $url_imagen[0]->url_image))){
                        ...
                        $result  =  DB::table('imagen')
                         ...
                         // return json_encode(['data' => 'Actualizado el registro correctamente!','state' => 'ok','src2' => '/img/mc_descuento_usuario/'.$request->id_producto.'/'.$filename]);
                      ...
                      if($file3 != NULL &&  $id_imagen_3 != NULL){
                        ...
                        if(file_exists(str_replace('/img/', 'img/',  $url_imagen[0]->url_image))){
                          ...
                          $result  =  DB::table('imagen')
                            ...
                            //return json_encode(['data' => 'Actualizado el registro correctamente!','state' => 'ok','src3' => '/img/mc_descuento_usuario/'.$request->id_producto.'/'.$filename]);
                        ...
                        if($file4 != NULL &&  $id_imagen_4 != NULL){
                          ...
                          if(file_exists(str_replace('/img/', 'img/',  $url_imagen[0]->url_image))){
                            ...
                            $result  =  DB::table('imagen')
                              ...
                              //return json_encode(['data' => 'Actualizado el registro correctamente!','state' => 'ok','src4' => '/img/mc_descuento_usuario/'.$request->id_producto.'/'.$filename]);
                          ...
                          if($file5 != NULL &&  $id_imagen_5 != NULL){
                            ...
                            if(file_exists(str_replace('/img/', 'img/',  $url_imagen[0]->url_image))){
                              ...
                              $result  =  DB::table('imagen')
                               ...
                               // return json_encode(['data' => 'Actualizado el registro correctamente!','state' => 'ok','src5' => '/img/mc_descuento_usuario/'.$request->id_producto.'/'.$filename]);
            ...
            case 'ELIMINAR': 
              ...
              try {
                  ...
                  if(file_exists('img/mc_descuento_usuario/'.$request->id_producto)){
                    $folderPath=public_path('img/mc_descuento_usuario/'.$request->id_producto);
