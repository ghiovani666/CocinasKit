         ...
         switch($request->isValues) {
          ...
          case 'ACTUALIZAR': 
            ...
            case 'ELIMINAR': 
                  ...
                  $id_imagen_ = DB::table('imagen')->where('id_product', '=',  349)->skip(0)->take(1)->get();

                  if(file_exists(str_replace('/img/', 'img/',  '/img/mc_composicion_oferta/'.$request->id_producto))){
                    unlink(str_replace('/img/', 'img/',  '/img/mc_composicion_oferta/'.$request->id_producto));
                  }
                  ...
                  DB::table('mc_colores_intermedio')->where('id_product', '=', $request->id_producto)->delete();
                  DB::table('mc_tirador_intermedio')->where('id_product', '=', $request->id_producto)->delete();
                  DB::table('mc_enzimera_intermedio')->where('id_product', '=', $request->id_producto)->delete();
