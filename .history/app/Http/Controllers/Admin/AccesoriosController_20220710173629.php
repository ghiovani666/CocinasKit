...
class AccesoriosController extends Controller {
 ...
 {        
            ...
            try {
                ...
                if($file0 != NULL &&  $id_imagen_0 != NULL){
                  $url_imagen =  DB::table('imagen')->where('id_imagen', '=', $id_imagen_0)->get();
                    ...
                    $filename0  =  time() .'_'.$file0->getClientOriginalName(); 
                    $path0 = "img/mc_accesorios/".$request->id_producto;
                    $file0->move($path0,$filename0); 
      
                    DB::table('imagen')
                      ->where("id_imagen",$id_imagen_0)
                      ->update([
                        'url_image' => '/img/mc_accesorios/'.$request->id_producto.'/'.$filename0, 
                        'updated_at' =>date("Y-m-d H:i:s")
                      ]); 
                  }
                  ...
                  if($file1 != NULL &&  $id_imagen_1 != NULL){
                    ...
                    if(file_exists(str_replace('/img/', 'img/',  $url_imagen[0]->url_image))){
                      ...
                      $filename1  =  time() .'_'.$file1->getClientOriginalName(); 
                      $path1 = "img/mc_accesorios/".$request->id_producto;
                      $file1->move($path1,$filename1); 
        
                      DB::table('imagen')
                      ->where("id_imagen",$id_imagen_1)
                        ->update([
                          'url_image' => '/img/mc_accesorios/'.$request->id_producto.'/'.$filename1, 
                          'updated_at' =>date("Y-m-d H:i:s")
                        ]); 
                    }else{
                      if($file1 != NULL){
                    ...
                    if($file2 != NULL &&  $id_imagen_2 != NULL){
                      ...
                      if(file_exists(str_replace('/img/', 'img/',  $url_imagen[0]->url_image))){
                        ...
                        $filename2  =  time() .'_'.$file2->getClientOriginalName(); 
                        $path2 = "img/mc_accesorios/".$request->id_producto;
                        $file2->move($path2,$filename2); 
          
                         DB::table('imagen')
                          ->where("id_imagen",$id_imagen_2)
                          ->update([
                            'url_image' => '/img/mc_accesorios/'.$request->id_producto.'/'.$filename2, 
                            'updated_at' =>date("Y-m-d H:i:s")
                          ]); 
                        }else{
                          if($file2 != NULL){
                      ...
                      if($file3 != NULL &&  $id_imagen_3 != NULL){
                        ...
                        if(file_exists(str_replace('/img/', 'img/',  $url_imagen[0]->url_image))){
                          ...
                          $filename3  =  time() .'_'.$file3->getClientOriginalName(); 
                          $path3 = "img/mc_accesorios/".$request->id_producto;
                          $file3->move($path3,$filename3); 
            
                          DB::table('imagen')
                            ->where("id_imagen",$id_imagen_3)
                            ->update([
                              'url_image' => '/img/mc_accesorios/'.$request->id_producto.'/'.$filename3, 
                              'updated_at' =>date("Y-m-d H:i:s")
                            ]); 
                          }else{
                            if($file3 != NULL){
                        ...
                        if($file4 != NULL &&  $id_imagen_4 != NULL){
                          ...
                          if(file_exists(str_replace('/img/', 'img/',  $url_imagen[0]->url_image))){
                            ...
                            $filename4  =  time() .'_'.$file4->getClientOriginalName(); 
                            $path4 = "img/mc_accesorios/".$request->id_producto;
                            $file4->move($path4,$filename4); 
              
                             DB::table('imagen')
                              ->where("id_imagen",$id_imagen_4)
                              ->update([
                                'url_image' => '/img/mc_accesorios/'.$request->id_producto.'/'.$filename4, 
                                'updated_at' =>date("Y-m-d H:i:s")
                              ]); 
                            }else{
                              if($file4 != NULL){
                          ...
                          if($file5 != NULL &&  $id_imagen_5 != NULL){
                            ...
                            if(file_exists(str_replace('/img/', 'img/',  $url_imagen[0]->url_image))){
                              ...
                              $filename5  =  time() .'_'.$file5->getClientOriginalName(); 
                              $path5 = "img/mc_accesorios/".$request->id_producto;
                              $file5->move($path5,$filename5); 
                
                              DB::table('imagen')
                                ->where("id_imagen",$id_imagen_5)
                                ->update([
                                  'url_image' => '/img/mc_accesorios/'.$request->id_producto.'/'.$filename5, 
                                  'updated_at' =>date("Y-m-d H:i:s")
                                ]); 
                              }else{
                                if($file5 != NULL){
  ...
  public function accesorios_eliminar_medida(Request $request) {
    DB::beginTransaction();
