...
class MuebleCompletoController extends Controller {
    ...
    public function mueble_completo_general($id_cat) {
    ...
    public function mueble_completo_detalle($id) {
        try {
        ...
        return view('web.pages.mueble_completo.web_mueble_completo_detalle', compact('Products'));
    ...
    return view('web.pages.mueble_completo.ajax.table_colores')
    ->with(compact('rdData'));
    //  return $html;
    }
