...
use Illuminate\Support\Facades\Session;
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
        ...
        Route::get('/admin_accesorios',                      'Admin\AccesoriosController@admin_accesorios');
        Route::get('/admin_accesorios_listar',               'Admin\AccesoriosController@admin_accesorios_listar');
        Route::get('/admin_accesorios_listar_combobox',      'Admin\AccesoriosController@admin_accesorios_listar_combobox');
        Route::post('/admin_accesorios_crear',               'Admin\AccesoriosController@admin_accesorios_crear');
        Route::post('/admin_accesorios_editar',              'Admin\AccesoriosController@admin_accesorios_editar');
