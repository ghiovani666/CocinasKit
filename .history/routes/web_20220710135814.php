...
use Illuminate\Support\Facades\Session;
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
        ...
        Route::post('/accesorios_crear_medida',        'Admin\MuebleCompletoController@accesorios_crear_medida');
        Route::get('/accesorios_listar_medidas',       'Admin\MuebleCompletoController@accesorios_listar_medidas');
