...
use Illuminate\Support\Facades\Session;
    ...
    Route::post('/calcular_total_precio_medida',        'Web\MuebleCompletoController@calcular_total_precio_medida');
        ...
        Route::post('/html_imagen_modelo_puerta',           'Web\ElementoDecorativoController@html_imagen_modelo_puerta');
        Route::get('/html_imagen_colores',                  'Web\ElementoDecorativoController@html_imagen_colores');
        Route::post('/calcular_total_precio_medida',        'Web\ElementoDecorativoController@calcular_total_precio_medida');
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
        ...
        Route::post('/accesorios_eliminar_medida',     'Admin\AccesoriosController@accesorios_eliminar_medida');
                ...
                Route::get('/mueble_costado',                      'Admin\MuebleColoresController@mueble_costado');
                Route::get('/mueble_costado_listar',               'Admin\MuebleColoresController@mueble_costado_listar');
                Route::post('/mueble_costado_crear',               'Admin\MuebleColoresController@mueble_costado_crear');
                Route::post('/mueble_costado_editar',              'Admin\MuebleColoresController@mueble_costado_editar');

                //::::::::::::::::::::::: CONTROLLER MANTENIMIENTO REGLETA: CRUD ::::::::::::::::::::::::::
                Route::get('/mueble_regleta',                      'Admin\MuebleColoresController@mueble_regleta');
                Route::get('/mueble_regleta_listar',               'Admin\MuebleColoresController@mueble_regleta_listar');
                Route::post('/mueble_regleta_crear',               'Admin\MuebleColoresController@mueble_regleta_crear');
                Route::post('/mueble_regleta_editar',              'Admin\MuebleColoresController@mueble_regleta_editar');
