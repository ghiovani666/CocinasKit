...
use Illuminate\Support\Facades\Session;
    ...
    Route::get('/mueble_completo_detalle/{id}',                 'Web\MuebleCompletoController@mueble_completo_detalle');
    ...
    Route::get('/checkout-page',            ['Web\HomeController'::class,'checkoutPage'])->name('checkout-page');
