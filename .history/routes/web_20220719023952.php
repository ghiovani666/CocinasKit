...
use Illuminate\Support\Facades\Session;
    ...
    Route::post('/calcular_total_precio_medida',        'Web\MuebleCompletoController@calcular_total_precio_medida');
        ...
        Route::get('/mueble_completo/{id}',                 'Web\ElementoDecorativoController@mueble_completo');
        Route::get('/mueble_completo_/{id}/{id2}',          'Web\ElementoDecorativoController@mueble_completo_');
