...
use Illuminate\Support\Facades\Session;
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
        ...
        Route::get('/descuento_usuario',                      'Admin\descuento_usuarioController@descuento_usuario');
        Route::get('/descuento_usuario_listar',               'Admin\descuento_usuarioController@descuento_usuario_listar');
        Route::get('/descuento_usuario_listar_combobox',      'Admin\descuento_usuarioController@descuento_usuario_listar_combobox');
        Route::post('/descuento_usuario_crear',               'Admin\descuento_usuarioController@descuento_usuario_crear');
        Route::post('/descuento_usuario_editar',              'Admin\descuento_usuarioController@descuento_usuario_editar');
