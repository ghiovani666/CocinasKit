...
use Illuminate\Support\Facades\Session;
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
        ...
        Route::get('/mainProducto',             'Admin\ComposicionOfertaController@mainProducto');
        Route::get('/listarProducto',           'Admin\ComposicionOfertaController@listarProducto');
        Route::post('/createServicioGaleria',   'Admin\ComposicionOfertaController@createServicioGaleria');
        Route::post('/editServicioGaleria',     'Admin\ComposicionOfertaController@editServicioGaleria');
