...
use Illuminate\Support\Facades\Session;
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
        ...
        Route::get('/admin_accesorios',                      'Admin\MuebleCompletoController@admin_accesorios');
        Route::get('/admin_accesorios_listar',               'Admin\MuebleCompletoController@admin_accesorios_listar');
        Route::get('/admin_accesorios_listar_combobox',      'Admin\MuebleCompletoController@admin_accesorios_listar_combobox');
        Route::post('/admin_accesorios_crear',               'Admin\MuebleCompletoController@admin_accesorios_crear');
        Route::post('/admin_accesorios_editar',              'Admin\MuebleCompletoController@admin_accesorios_editar');
