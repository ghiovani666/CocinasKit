...
use Illuminate\Support\Facades\Session;
    ...
    // Route::get('/lista_deseo',              'Web\DescuentoUsuarioController@lista_deseo');
    Route::post('/web_descuento_usuario',      'Web\DescuentoUsuarioController@web_descuento_usuario');
    // Route::get('/lista_deseo_remover/{id}', 'Web\DescuentoUsuarioController@lista_deseo_remover');
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
        ...
        Route::get('/mueble_colores',                      'Admin\DescuentoUsuarioController@mueble_colores');
        Route::get('/mueble_colores_listar',               'Admin\DescuentoUsuarioController@mueble_colores_listar');
        Route::get('/mueble_colores_listar_combobox',      'Admin\DescuentoUsuarioController@mueble_colores_listar_combobox');
        Route::post('/mueble_colores_crear',               'Admin\DescuentoUsuarioController@mueble_colores_crear');
        Route::post('/mueble_colores_editar',              'Admin\DescuentoUsuarioController@mueble_colores_editar');
