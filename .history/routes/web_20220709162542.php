...
use Illuminate\Support\Facades\Session;
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
        ...
        //Route::get('/filtro_combobox_cbOpcionMueble',      'Admin\MuebleCompletoController@filtro_combobox_cbOpcionMueble');
        Route::post('/mueble_completo_crear_medida',       'Admin\MuebleCompletoController@mueble_completo_crear_medida');
        Route::get('/listar_medidas',               'Admin\MuebleCompletoController@listar_medidas');
