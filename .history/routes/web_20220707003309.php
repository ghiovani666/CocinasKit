...
use Illuminate\Support\Facades\Session;
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
        ...
        Route::get('/mueble_puertas',                      'Admin\MuebleColoresController@mueble_puertas');
        Route::get('/mueble_puertas_listar',               'Admin\MuebleColoresController@mueble_puertas_listar');
        Route::post('/mueble_puertas_crear',               'Admin\MuebleColoresController@mueble_puertas_crear');
        Route::post('/mueble_puertas_editar',              'Admin\MuebleColoresController@mueble_puertas_editar');
