...
<li class="dropdown mega-menu-fullwidth">
    ...
    @elseif($data1->id_menu == 7)
    <a href="/galeriaPrincipal/{{$data1->id_menu}}" class="dropdown-toggle" data-hover="dropdown">
    {{$data1->names}}
    </a>
    @elseif($data1->id_menu == 4)
    <a href="/mueble_completo/{{$data1->id_menu}}" class="dropdown-toggle" data-hover="dropdown">
    {{$data1->names}}
    </a>
    @else
                        ...
                        <div class="col-md-3 col-sm-6">
                            <h3 style="font: inherit;" class="mega-menu-heading">
                                <a style="font-size: 20px;font-weight: 600;"
                                    href="/composicion_oferta/{{$data2->id_cat}}">{{$data2->names}}</a>
                            </h3>
                            <nav role='navigation' class="main-nav">
                                <ul>
                                    ...
                                    <li class="longitud_cocina">
                                        <a style="font-size: 17px;padding-left: 10px;" href="/{{ ($data3->id_item==54 || $data3->id_item==55)?'elemento_decorativo':'mueble_completo' }}/{{$data3->id_item}}">
                                            <!-- <img src="/assets/img/escurreplatos.png" alt="" style="margin: 10px;"> -->
                                            <div style="padding-bottom: 0.5em;margin-top: -10px;"><br />
