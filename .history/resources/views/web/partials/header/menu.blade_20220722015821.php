                        ...
                        <div class="col-md-3 col-sm-6">
                            <h3 style="font: inherit;" class="mega-menu-heading">
                                <a style="font-size: 20px;font-weight: 600;"
                                    href="/mueble_completo_general/{{$data2->id_cat}}">{{$data2->names}}</a>
                            </h3>
                            <nav role='navigation' class="main-nav">
                                <ul>
                                    ...
                                    <li class="longitud_cocina">
                                        <a style="font-size: 17px;padding-left: 10px;" href="/{{ ($data3->id_item==54 || $data3->id_item==55)?'elemento_decorativo':'mueble_completo_detalle' }}/{{$data3->id_item}}">
