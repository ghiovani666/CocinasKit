...
<div class="modal fade"  id="modalOpen" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" role="form" method="POST" action="{{ url('/web_descuento_usuario_') }}">
            ...
            {{ csrf_field() }}
                    ...
                    <div class="form-group text-center">
                        <button class="btn btn-success">Enviar Ahora</button>
                    </div>
                </form>
...
$('#uploadFormProfesional').on('submit', function(e) {
    ...
    axios.get('web_descuento_usuario_',
        formData, {
            headers: {
