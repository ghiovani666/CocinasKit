...
<div class="header-v5 header-static margin-bottom-30 printMultipleDiv">
    ...
    <div class="navbar navbar-default mega-menu" role="navigation" style="background: #ffffff;">
        ...
        <div id="logo_cocina" class="nav navbar-nav" style="margin-bottom: 20px;margin-top: 20px;">
            <a href="/"><img style="width: 345px;" id="logo_cocinsa" src="{{ $footerData[0]->url_image }}"
                    alt="Logo"></a>
        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form  role="form" method="POST" action="{{ url('/web_descuento_usuario') }}">
...
@if($message = session() -> has('succes_message'))
Swal.fire(
    'Good job!',
...
// $('#uploadFormProfesional').on('submit', function(e) {
//     e.preventDefault();
...
//     axios.get('web_descuento_usuario',
//         formData, {
//             headers: {
