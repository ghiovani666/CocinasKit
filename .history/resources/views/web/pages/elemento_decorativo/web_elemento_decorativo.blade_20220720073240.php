            ...
            <div itemscope itemtype="https://schema.org/Product">
                <div class="cocinakit-mueble-general cocinakit-mueble-kit primary_block row ">
                    ...
                    <form action="{{url('/cart/addItem')}}/<?php echo $Products[0]->id; ?>">
                        ...
                        <?php  
                            $ColorData = DB::select("SELECT * FROM mc_colores M LEFT JOIN (SELECT cin.id_color,cin.id_producto FROM mc_colores c INNER JOIN mc_colores_intermedio cin ON c.id=cin.id_color WHERE cin.id_producto = ?)  AS T ON M.id=T.id_color ORDER BY M.id asc", [$Products[0]->id]);                                   
                        ?>
                        <!--=== COLUMNA 2 ===-->
