            ...
            <div itemscope itemtype="https://schema.org/Product">
                <div class="cocinakit-mueble-general cocinakit-mueble-kit primary_block row ">
                    ...
                    <form action="{{url('/cart/addItem')}}/<?php echo $Products[0]->id; ?>">
                        ...
                        <?php  
                            $modeloPuerta = DB::select("SELECT c.* FROM mc_modelo_puerta c INNER JOIN mc_modelo_puerta_intermedio cin ON c.id=cin.id_modelo_puerta WHERE cin.id_producto=395");                                      
                        ?>
                        <!--=== COLUMNA 2 ===-->
                                        ...
                                        <div class="col-sm-8 margin-bottom-10" style="background: #f1f1f0;">
                                            <div class="panel-body"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <?php  
                                                        $altImgs = DB::select("SELECT c.* FROM mc_colores c INNER JOIN mc_colores_intermedio cin ON c.id=cin.id_color WHERE cin.id_producto=395");                                      
                                                    ?>
                                                        <div>
                                    ...
                                    <fieldset class="attribute_fieldset" style="height: 290px;">
                                        <div class="row col-sm-12 margin-bottom-30">
                                            ...
                                            $sizes = DB::select("
                                                        ...
                                                        WHERE p.id_item in (24) ORDER BY p.id asc") ;
                                            ?>
                                            @if(count($sizes)!=0)
                                            ...
                                            <div class="row margin-bottom-30">
                                                <div class="col-sm-3">
                                                    ...
                                                    $sizes = DB::select("
                                                            ...
                                                            FROM  medida as md
                                                            WHERE md.id_imagen in (293) ORDER BY md.id_medida asc") ;
                                                    ?>
