...
$(document).ready(function() {
    ...
    getTirador(1)
    getModuloPuerta(<?php echo (count($modeloPuerta)!=0 || !empty($modeloPuerta)  ?$modeloPuerta[0]->id:'');?>) //Para puertas
    getModuloPuertaColor(<?php echo (count($modeloPuerta)!=0 || !empty($modeloPuerta)  ?$modeloPuerta[0]->id:'');?>) //Para colores
