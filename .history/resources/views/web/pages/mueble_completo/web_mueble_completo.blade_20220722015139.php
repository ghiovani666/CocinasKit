                            ...
                            <div class="col-sm-3">
                                ...
                                <li class="item box_shadom_imagen  margin-bottom-30">
                                    <div class="product-img">
                                        <a href="{{url('/mueble_completo_detalle')}}/{{$product->id_item}}"><img
                                                class="full-width img-responsive"
                                                src="<?php echo $product->url_image; ?>" alt=""></a>
                                        <a class="product-review"
                                            href="{{url('/mueble_completo_detalle')}}/{{$product->id_item}}">Mas
                                            Información</a>
                                    </div>
                                        ...
                                        <div class="overflow-h margin-bottom-5">
                                            <div class="pull-left">
                                                <h4 class="title-price"><a
                                                        href="{{url('/mueble_completo_detalle')}}/{{$product->id_item}}"><?php echo $product->pro_name; ?></a>
                                                </h4>
                                                <span class="gender">
