            ...
            <div itemscope itemtype="https://schema.org/Product">
                <div class="cocinakit-mueble-general cocinakit-mueble-kit primary_block row ">
                    ...
                    <form action="{{url('/cart/addItem')}}/<?php echo $Products[0]->id; ?>">
                        ...
                        <?php  
                            $modeloPuerta = DB::select("SELECT * FROM mc_modelo_puerta c INNER JOIN mc_modelo_puerta_intermedio cin ON c.id=cin.id_modelo_puerta WHERE cin.id_producto=? ORDER BY c.id ASC", [$Products[0]->id]);                                   
                        ?>
                        <!--=== COLUMNA 2 ===-->
                                ...
                                <div id="attributes">
                                    <fieldset class="attribute_fieldset" style="height: 290px;">
                                        <div class="row col-sm-12 margin-bottom-30">
                                            ...
                                            ?>
                                            @if(count($sizes)!=0)
                                            <select name="id_producto_id_item" id="id_producto_id_item" class="form-control">
                                            ...
                                            <div class="margin-bottom-40">
                                                ...
                                                <div class="col-sm-12" style="display: flex;">
                                                    ...
                                                    <label class="form-check-label"
                                                        style="margin-left: 10px;padding-top: 5px" for="txt_apertura">
                                                        Derecha
                                                    </label>
                                                    @endif
...
$(document).ready(function() {
    ...
    getTirador(1)
    getModuloPuerta(<?php echo (count($modeloPuerta)!=0?$modeloPuerta[0]->id:'');?>) //Para puertas
    getModuloPuertaColor(<?php echo (count($modeloPuerta)!=0?$modeloPuerta[0]->id:'');?>) //Para colores
