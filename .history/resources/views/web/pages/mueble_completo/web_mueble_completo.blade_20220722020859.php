                            ...
                            <div class="col-sm-3">
                                ...
                                <li class="item box_shadom_imagen  margin-bottom-30">
                                    <div class="product-img">
                                        <a href="/{{ ($product->id_item==54 || $product->id_item==55)?'elemento_decorativo':'mueble_completo_detalle' }}/{{$product->id_item}}"><img
                                                class="full-width img-responsive"
                                                src="<?php echo $product->url_image; ?>" alt=""></a>
                                        <a class="product-review"
                                            href="/{{ ($product->id_item==54 || $product->id_item==55)?'elemento_decorativo':'mueble_completo_detalle' }}/{{$product->id_item}}">Mas
                                            Información</a>
                                    </div>
                                    <div class="product-description product-description-brd" style="background: white;">
                                        <div class="overflow-h margin-bottom-5">
                                            ...
                                            /elemento_decorativo/54

                                                <h4 class="title-price"><a
                                                        href="/{{ ($product->id_item==54 || $product->id_item==55)?'elemento_decorativo':'mueble_completo_detalle' }}/{{$product->id_item}}"><?php echo $product->pro_name; ?></a>
                                                </h4>
                                                <span class="gender">
