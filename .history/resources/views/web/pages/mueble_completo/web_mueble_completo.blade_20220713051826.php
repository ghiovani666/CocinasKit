                                    ...
                                    <div id="attributes">
                                        <div class="col-sm-8 margin-bottom-10" style="background: #f1f1f0;">
                                            <div class="panel-body"
                                                ...
                                                <div id="modelo_colores">
                                                <tbody>
    <tr>
        <div>
                        <label class="radio-img" title="GRIS CLARO">
                <input type="radio" name="color_puertas" value="1" />
                <img style="width: 40px;" src="/img/color_imagen/103 SM GRIS CLARO.jpg">
            </label>
                        <label class="radio-img" title="N4 NATURIA">
                <input type="radio" name="color_puertas" value="25" />
                <img style="width: 40px;" src="/img/color_imagen/N4 NATURIA.jpg">
            </label>
                        <label class="radio-img" title="MARRON">
                <input type="radio" name="color_puertas" value="3" />
                <img style="width: 40px;" src="/img/color_imagen/108 SM MARRON.jpg">
            </label>
                        <label class="radio-img" title="GRIS OSCURO MT">
                <input type="radio" name="color_puertas" value="5" />
                <img style="width: 40px;" src="/img/color_imagen/4024MM GRIS OSCURO MT.jpg">
            </label>
                    </div>
    </tr>
</tbody>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body" id="updateDivPrincipal" style="text-align: center;">
                                    <img src="#" id="zoomImgModal" style="width: 8vw;"/>
                                </div>
...
$("input[type=radio][name=modelo_puertas]").change(function() {
    ...
    getColoresPuertas(id_modelo_puerta,<?php echo $Products[0]->id; ?>)
});

const getColoresPuertas = (id_modelo_puerta,id_producto) => {

    console.log(id_modelo_puerta)
