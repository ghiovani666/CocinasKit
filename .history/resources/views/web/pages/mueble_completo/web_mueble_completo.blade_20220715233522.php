                    ...
                    <div class="col-xs-12 show-right-info col-md-4">
                        <div class="product-title">
                            <h1 itemprop="name" style="background-color: #6f6f6f !important;">
                                <?php echo ucwords((count($Products)!=0? $Products[0]->pro_name:'') ); ?></h1>
                        </div>
                        <!-- Master Slider -->
                        <div class="master-slider ms-skin-default" id="masterslider">
                            <div class="flexslider" id="updateDiv">
                                <div class="zoom" id="produto">
                                    <img src="{{ (count($Products)!=0? $Products[0]->url_image:'') }}" id="txt_imagenPrincipal" width="500px"
                                        style="height: 287px;" />
                                </div>
                            </div>
                        </div>
...
const getModuloPuertaColor = (id_modelo_puerta) => {
    $.ajax({
        ...
        data: {
            ...
            id_producto: <?php echo $Products[0]->id?>
        },
        success: function(response) {
