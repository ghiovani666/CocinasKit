                        ...
                        <div class="product_attributes margin-bottom-10">
                            ...
                            <div class="col-8 col-sm-8">
                                ...
                                <div class="txt_modelo_tirador_unero">
                                    ...
                                    <?php  
                                        $tiradorUnero = DB::table('mc_tirador_unero')
                                        // ->where('orden','1')
                                        ->get();
                                        ?>
                                    <div style="display: flex;">
...
const getTirador = (txt_id_tirador) => {
...
$("input[type=radio][name=txt_model_tiradorUnero]").click(function() {
    const txt_id_ = $('input[name="txt_model_tiradorUnero"]:checked').val();
    getTiradorUnero(txt_id_.split('-')[1])
    console.log(txt_id_.split('-')[1])
});
