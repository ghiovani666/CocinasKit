...
<div class="container">
        ...
        <div class="tp-banner">
            <ul>
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000"
                    data-title="Slide 1">
                    <!-- MAIN IMAGE -->
                    <img src="/img/slider_principal/1629093039_1.jpg" alt="darkblurbg" data-bgfit="cover"
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000"
                    data-title="Slide 2">
                    <!-- MAIN IMAGE -->
                    <img src="/img/slider_principal/img/5.png" alt="darkblurbg" data-bgfit="cover" data-bgposition="left top"
                        data-bgrepeat="no-repeat">

                    <div class="tp-caption revolution-ch3 sft start" data-x="center" data-hoffset="0" data-y="140"
                        data-speed="1500" data-start="500" data-easing="Back.easeInOut" data-endeasing="Power1.easeIn"
                        data-endspeed="300">
                        Últimas <strong>tendencias</strong> en Diseños
                    </div>

                    <!-- LAYER -->
                    <div class="tp-caption revolution-ch4 sft" data-x="center" data-hoffset="-14" data-y="210"
                        data-speed="1400" data-start="2000" data-easing="Power4.easeOut" data-endspeed="300"
                        data-endeasing="Power1.easeIn" data-captionhidden="off" style="z-index: 6">
                    ...
                    <!-- LAYER -->
                    <div class="tp-caption sft" data-x="center" data-hoffset="0" data-y="300" data-speed="1600"
                        data-start="1800" data-easing="Power4.easeOut" data-endspeed="300"
                        data-endeasing="Power1.easeIn" data-captionhidden="off" style="z-index: 6">
                        <a href="#" class="btn-u btn-brd btn-brd-hover btn-u-light">Mas Información</a>
                    </div>
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000"
                    data-title="Slide 1">
                    <!-- MAIN IMAGE -->
                    <img src="/img/slider_principal/3.png" alt="darkblurbg" data-bgfit="cover" data-bgposition="left top"
                        data-bgrepeat="no-repeat">

                    <div class="tp-caption revolution-ch1 sft start" data-x="center" data-hoffset="0" data-y="100"
                        data-speed="1500" data-start="500" data-easing="Back.easeInOut" data-endeasing="Power1.easeIn"
                        data-endspeed="300">
                        <strong>Garantizamos </strong> el Trabajo
                    </div>
    ...
    <div class="header-v5" style="background: black;margin-bottom: 25px;position: unset;">
        <h1 style="margin-bottom: 15px;color: white;padding: 15px 0px 0px 0px;text-align: center;">COMPOSICIONES EN OFERTAS</h1>
    </div>
    <!--=== Illustration v2 ===-->
        ...
        <ul class="list-inline owl-slider">
            ...
            <li class="item" style="margin: 1em !important;">
                <div class="product-img">
                    <a href="{{url('/product_details_')}}/{{$p->pro_id}}"><img style="height: 245px;" class="full-width img-responsive"
                            src="{{$p->url_image}}" alt=""></a>
                ...
                <div class="product-description product-description-brd" style="background: white;">
                    <div class="overflow-h margin-bottom-5">
                        <div class="pull-left">
                            <h4 class="title-price" style=" width: 230px;white-space: nowrap;text-overflow: ellipsis;overflow: hidden;"><a
