                        ...
                        <div class="col-xs-12 col-md-4">
                            ...
                            <div class="product_attributes clearfix margin-bottom-30">
                                ...
                                <div class="cko_procesar_pedido">
                                    ...
                                    <div id="quantity_wanted_p"> <label class="qty-label">Cantidad:</label>
                                        <div class="quantity-input-wrapper"> <input type="text" name="qty"
                                                id="quantity_wanted" class="text" value="1"
                                                style="border: 1px solid rgb(189, 194, 201);"> <a href="#"
                                                data-field-qty="qty" class="transition-300 product_quantity_down">
                                                <span><i class="icon-caret-down"></i></span> </a> <a href="#"
                                                data-field-qty="qty" class="transition-300 product_quantity_up ">
                                                <span><i class="icon-caret-up"></i></span> </a></div> <span
                                            class="clearfix"></span>
                                    </div>
                                    <div class="content_prices clearfix">
                                        <div class="price"> <label>TOTAL</label>
                                            <p class="our_price_display" itemprop="offers" itemscope=""
                                                ...
                                                <span id="our_price_display" itemprop="price" content="228.85">228,85
                                                    €</span>
                                                <meta itemprop="priceCurrency" content="EUR">
                                            </p>
                                            <p id="old_price" class="hidden"> <span id="old_price_display">228,85
                                                    €</span></p>
                                        </div>
...
addtocartbtnDom.forEach(addtocartbtnDom => {
  ...
  <div class="animated flipInX">
    ...
    <div class="p-2 mt-3 ml-auto">
        <button class=" " type="button" data-action="increase-item">&plus;
    </div>
    <div class="p-2 mt-3">
      <p class="text-success cart_item_quantity">${product.quantity}</p>
    </div>
    <div class="p-2 mt-3">
      <button class=" " type="button" data-action="decrease-item">&minus;
    </div>
    <div class="p-2 mt-3">
      <button class=" " type="button" data-action="remove-item">&times;
    </div>
  </div> `);

            if (document.querySelector('.cart-footer') === null) {
                cartDom.insertAdjacentHTML("afterend", `
      <div class=" card cart-footer mt-2 mb-3 animated flipInX">
        <div class="p-2">
          <button class=" " type="button" data-action="clear-cart">Clear Cart
        </div>
        <div class="p-2 ml-auto">
          <button class=" " type="button" data-action="check-out">Pay <span class="pay"></span> 
            &#10137;
        </div>
      </div>`);
            }
