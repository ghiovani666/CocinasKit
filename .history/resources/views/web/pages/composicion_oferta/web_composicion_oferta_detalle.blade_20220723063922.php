                                            ...
                                            <div>
                                                <label class="radio-img"
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="hidden" name="product-name" value="{{$altImg->nombre}}">
                                                        <input type="hidden" name="product-name" value="{{$altImg->precio}}">
                                            ...
                                            <div>
                                                <label class="radio-img"
                                                    ...
                                                    <img class="product-img" style="width: 50px;height: 40px;"
                                                        src="{{$altImg->url_image}}" onmouseover="animateImg(this)"
                                                        onmouseout="normalImg(this)">
                                                    <p style="display: none;" class="product-name">
                                                        {{$altImg->nombre}}
                                                    </p>
                                                    <p style="display: none;" class="product-price">
                                                        {{$altImg->precio}}
                                                    </p>
                                                    <button type="button" style="margin-top: 4px;"
                                                        data-action="add-to-cart">Añadir</button>
