                    ...
                    <form action="{{url('/cart/addItem')}}/<?php echo $Products[0]->id; ?>">
                                            ...
                                            <div class="panel-body">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        $altImgs = DB::select("SELECT cin.id_color,cin.id_producto FROM mc_colores c INNER JOIN mc_colores_intermedio cin ON c.id=cin.id_color WHERE cin.id_producto=?", [$Products[0]->id]);
                            ...
                            <div class="product_attributes margin-bottom-10">
                                ...
                                <fieldset style="height: 150px;">
                                    ...
                                    <div class="col-8 col-sm-8">
                                        ...
                                        <div class="txt_modelo">
                                            <label for="layout" style="font-weight: bold;">COMPLETE SU PEDIDO
                                            </label><br />
                                        ...
                                        <div class="margin-bottom-10">
                                            <label class="form-check-label" for="patas" style="padding-right: 10px;">
                                                Copete:</label>
                                            <input class="form-check-input" type="checkbox" name="txt_tirador"
                                                value="1">
                                        </div>
                        ...
                        <div class="col-xs-12 col-md-4">
                            ...
                            <div class="product_attributes clearfix margin-bottom-30"
                                style="background: #f1f1f0;height: 276px;">
