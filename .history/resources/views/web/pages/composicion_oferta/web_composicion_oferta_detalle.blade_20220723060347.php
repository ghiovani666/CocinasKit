        ...
        <div class="col-sm-12 col-md-12 col-lg-6 col-xs-12">
          ...
          <div class="row">
            ...
            <div >
                ...
                <img  src="./img/bottle.jpg" alt="prd1" onmouseover="animateImg(this)" onmouseout="normalImg(this)"/>
             
                  <h5 class="product-name">Water Bootle</h5>
                  <p class="product-price">200 Rs.</p>
                  <button class="" type="button" data-action="add-to-cart">Add to cart</button>
