          ...
          <button class="btn badge-dark" type="button" data-action="check-out">Pay <span class="pay"></span> 
            ...
            cartItemsDom.forEach(cartItemDom => {
                ...
                if (cartItemDom.querySelector(".cart_item_name").innerText === product.name) {
                    ...
                    let costoTotal__= document.querySelector('input[name="costo_total"]').value;
                    
                    
                    let sumTotal___ = parseFloat(cartTotal)+parseFloat(costoTotal__)
                    document.querySelector('input[name="costo_total"]').value =sumTotal___;
                        ...
                        "click", () => {
                            cart.forEach(cartItem => {
                                if (cartItem.name === product.name) {
                                    ...
                                    let sumTotal_ = parseFloat(cartTotal)+parseFloat(costoTotal__)
                            ...
                            cart.forEach(cartItem => {
                                if (cartItem.name === product.name) {
                                    if (cartItem.quantity > 1) {
                                        ...
                                        let sumTotal_ = parseFloat(costoTotalDecreciente) - parseFloat(parseInt(cartItem.price))
                                        document.querySelector('input[name="costo_total"]').value =sumTotal_;
