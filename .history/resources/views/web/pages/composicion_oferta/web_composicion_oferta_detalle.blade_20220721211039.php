                        ...
                        <div class="col-xs-12 col-md-4">
                            ...
                            <div class="product_attributes margin-bottom-10">
                                ...
                                <fieldset style="height: 50px;">
                                    ...
                                    <label style="text-align: center;margin-top: 14px;font-size: 16px;"> <strong id="valorEnzimera_"> € 253.55</strong> </label>
                                    </div>
                                </fieldset>
                            </div>
                            ...
                            <div class="product_attributes margin-bottom-10">
                                ...
                                <fieldset style="height: 50px;">
                                    ...
                                    <div class="col-4 col-sm-3">
                                    <label style="text-align: center;margin-top: 14px;font-size: 16px;"> <strong id="valorCopete_"> € 253.55</strong> </label>
                                    </div>
                                </fieldset>
...
$("input[type=radio][name=txt_model_copete]").click(function() {
    ...
    const valor2 = parseFloat(valorEnzimera.split('-')[0])
    console.log(valor2)
