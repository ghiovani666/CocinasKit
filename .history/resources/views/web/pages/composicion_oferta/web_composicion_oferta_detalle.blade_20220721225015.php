                                    ...
                                    <div class="col-4 col-sm-3">
                                        ...
                                        <label class="radio-img">
                                            ...
                                            <img style="width: 40px;" id="valorEnzimera_imagen"
                                                onclick="openModalEnzimera()" src="https://www.advancemetagenom.com/wp-content/uploads/2021/02/169-1695521_kisspng-computer-icons-check-mark-presentation-symbol-ok.jpg">
                                        </label>
                                    </div>
                                </fieldset>
                            </div>
