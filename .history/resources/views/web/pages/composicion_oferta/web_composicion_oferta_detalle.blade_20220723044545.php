                                    ...
                                    <div class="col-8 col-sm-10">
                                        <div class="txt_modelo" style="display: flex;">
                                            <?php  
                                                ...
                                                <label class="radio-img"  style="display: inline-grid;padding-right: 5px;">
                                                    <input type="radio" name="txt_model_enzimera"
                                                        onclick="setImagenEnzimera('{{$altImg->url_image}}')"
                                                        value="{{$altImg->precio}}-{{$altImg->id}}" />
                                                    <img class="product-img" style="width: 50px;height: 40px;" src="{{$altImg->url_image}}" onmouseover="animateImg(this)"  onmouseout="normalImg(this)">
                                               

                                                            <p style="display: none;" class="product-name">{{$altImg->nombre}}</p>
                                                            <p style="display: none;"  class="product-price">{{$altImg->precio}}</p>
                                                            <button type="button"  style="margin-top: 4px;" data-action="add-to-cart">Añadir</button>
...
<div class="pb-right-column-content"><h3 class="cko_pb_right_column_title">Procesar pedido</h3><div class="cko_procesar_pedido"><div id="cocinakit_cortemedida_section" class="clearfix"><h4>CORTE a MEDIDA<span id="cocinakit_corteamedida_incremento_precio">+50 €</span></h4><p>Elija la medida que desea cortar</p><div class="corteInputData"><div><span>Alto</span><input maxlength="4" type="text" id="cocinakit_corte_alto" name="corte_alto"></div> <span class="separator">X</span><div><span>Ancho</span><input maxlength="4" type="text" id="cocinakit_corte_ancho" name="corte_ancho"></div> <span class="separator">X</span><div><span>Fondo</span><input maxlength="4" type="text" id="cocinakit_corte_fondo" name="corte_fondo"></div> <button id="cocinakit_corteamedida_confirma" type="button" name="cocinakit_corteamedida_confirma" class="exclusive"> <span>Confirmar</span> </button></div></div><textarea class="clearfix" name="cocinakit_comentario_mueble" id="cocinakit_comentario_mueble" placeholder="Comentario sobre el mueble" cols="20" rows="2"></textarea><div id="quantity_wanted_p"> <label class="qty-label">Cantidad:</label><div class="quantity-input-wrapper"> <input type="text" name="qty" id="quantity_wanted" class="text" value="1" style="border: 1px solid rgb(189, 194, 201);"> <a href="#" data-field-qty="qty" class="transition-300 product_quantity_down"> <span><i class="icon-caret-down"></i></span> </a> <a href="#" data-field-qty="qty" class="transition-300 product_quantity_up "> <span><i class="icon-caret-up"></i></span> </a></div> <span class="clearfix"></span></div><div class="content_prices clearfix"><div class="price"> <label>TOTAL</label><p class="our_price_display" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer"><link itemprop="availability" href="http://schema.org/InStock"> <span id="our_price_display" itemprop="price" content="228.85">228,85 €</span><meta itemprop="priceCurrency" content="EUR"></p><p id="old_price" class="hidden"> <span id="old_price_display">228,85 €</span></p></div><p id="reduction_percent" style="display:none;"> <span id="reduction_percent_display"> </span></p><p id="reduction_amount" style="display:none"> <span id="reduction_amount_display"> </span></p><div class="clear"></div></div><div class="box-info-product"><div class="box-cart-bottom clearfix"><div class="add_to_cart_container pull-right"><p id="add_to_cart" class="buttons_bottom_block no-print"> <button type="submit" name="Submit" class="exclusive"> <span>Añadir al carrito</span> </button></p></div></div></div></div></div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary">Añadir pedido</button>
                                </div>
                            </div>
                        </div>
                    </div>
          ...
          <button class="btn badge-dark" type="button" data-action="check-out">Pay <span class="pay"></span> 
            ...
            cartItemsDom.forEach(cartItemDom => {
                ...
                if (cartItemDom.querySelector(".cart_item_name").innerText === product.name) {
                    ...
                    cartItemDom.querySelector('[data-action="increase-item"]').addEventListener(
                        "click", () => {
                            cart.forEach(cartItem => {
                                if (cartItem.name === product.name) {
                                    cartItemDom.querySelector(".cart_item_quantity")
                    ...
                    cartItemDom.querySelector('[data-action="decrease-item"]').addEventListener(
                        "click", () => {
                            cart.forEach(cartItem => {
                                if (cartItem.name === product.name) {
                    ...
                    cartItemDom.querySelector('[data-action="remove-item"]').addEventListener(
                        "click", () => {
                            cart.forEach(cartItem => {
                                if (cartItem.name === product.name) {
                                    ...
                                    document.querySelector('.pay').innerText =
                                        cartTotal + " Rs.";
                                    cartItemDom.remove();
                                    cart = cart.filter(cartItem => cartItem.name !==
                                        product.name);
                    ...
                    document.querySelector('[data-action="check-out"]').addEventListener(
                        "click", () => {
