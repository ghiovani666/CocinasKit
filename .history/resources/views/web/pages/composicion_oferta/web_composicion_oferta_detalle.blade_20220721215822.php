                        ...
                        <div class="col-xs-12 col-md-4">
                            ...
                            <div class="product_attributes margin-bottom-10">
                                ...
                                <fieldset style="height: 50px;">
                                    ...
                                    <label style="text-align: center;margin-top: 14px;font-size: 16px;"> <strong id="valorEnzimera_"> € 00.00</strong> </label>
                                    </div>
                                </fieldset>
                            </div>
                            ...
                            <div class="product_attributes margin-bottom-10">
                                ...
                                <fieldset style="height: 50px;">
                                        ...
                                        <div class="txt_modelo">
                                            ...
                                            <div>
                                                ...
                                                <label class="radio-img"  title="{{$altImg->nombre}}">
                                                    <input type="radio" name="txt_model_copete"  id="txt_model_copete{{$altImg->id}}"
                                                        value="{{$altImg->precio}}-{{$altImg->id}}" />
                                                    <img style="width: 40px;" src="{{$altImg->url_image}}">
                                                </label>
                                                @endforeach
                                    ...
                                    <div>
                                    <label style="text-align: center;margin-top: 14px;font-size: 14px;display: table-row;"> <strong id="valorCopete_"> € 00.00</strong> </label>
                                    <label class="radio-img">
                                        <img style="width: 40px;" src="/img/mc_copete/1658453700_descarga.png">
                                    </label>
                                </div>
                                </fieldset>
