                                ...
                                <fieldset style="height: 50px;">
                                    ...
                                    <div class="col-4 col-sm-3">
                                        ...
                                        <label class="radio-img">
                                            ...
                                            <img style="width: 40px;" id="valorCopete_imagen" src="#">
                                        </label>
                                    </div>
...
$("input[type=radio][name=radio_copete]").change(function() {
    $('#imagenModal').modal(true)

    console.log('11111111111')
    // // const txt_id_color = $('input[name="radio_copete"]:checked').val();
    // $('#zoomImgModal').attr('src', url_imagen);
