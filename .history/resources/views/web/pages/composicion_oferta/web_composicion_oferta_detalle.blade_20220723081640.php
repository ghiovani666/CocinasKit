                                                ...
                                                <label class="radio-img"
                                                    ...
                                                    <div>
                                                        ...
                                                        <button type="button" style="margin-top: 4px;"
                                                            data-action="add-to-cart">Añadir</button>
                                                    </div>
                                                </label>
                                            </div>
                                            @endforeach
...
addtocartbtnDom.forEach(addtocartbtnDom => {
    addtocartbtnDom.addEventListener("click", () => {
        ...
        const product = {
            ...
            name: productDom.querySelector('input[name="product-name"]').value,
            price: productDom.querySelector('input[name="product-price"]').value,
            quantity: 1
        };
  ...
  `);
      ...
      <div class="d-flex flex-row shadow-sm card cart-footer mt-2 mb-3 animated flipInX">
        <div class="p-2">
          <button class="btn badge-danger" type="button" data-action="clear-cart">Limpiar
        </div>
          ...
          <button class="btn badge-dark" type="button" data-action="check-out">Pay <span class="pay"></span> 
            ...
            cartItemsDom.forEach(cartItemDom => {
                ...
                if (cartItemDom.querySelector(".cart_item_name").innerText === product.name) {
                    ...
                    // cartTotal += parseInt(cartItemDom.querySelector(".cart_item_quantity").innerText) *parseFloat(cartItemDom.querySelector(".cart_item_price").innerText);
                    // document.querySelector('.pay').innerText = cartTotal + " €";

                    let precioOriginal= document.querySelector('input[name="costo_total"]').value;
                    
                    //:::::::::::::::: SUMA AL PRECIO ORIGINAL Y LO MUESTRA AL INPUT :::::::::::::::::::::::::::::::
                    let precioAgregado = parseFloat(cartItemDom.querySelector(".cart_item_price").innerText);
                    let sumTotalOriginal = precioAgregado + parseFloat(precioOriginal)
                    document.querySelector('input[name="costo_total"]').value =sumTotalOriginal.toFixed(2);
                    ...
                    cartItemDom.querySelector('[data-action="increase-item"]').addEventListener("click", () => {
                            cart.forEach(cartItem => {
                                if (cartItem.name === product.name) {
                                    ...
                                    cartItemDom.querySelector(".cart_item_price").innerText = (parseInt(cartItem.quantity) *parseFloat(cartItem.price)).toFixed(2);
                                    //cartTotal += parseFloat(cartItem.price)// UTILIZAMOS PARA EL REMOVE

                                    let costoTotalCreciente= document.querySelector('input[name="costo_total"]').value;
                                    let sumTotal_ = parseFloat(costoTotalCreciente) + parseFloat(precioAgregado)
                                    document.querySelector('input[name="costo_total"]').value =sumTotal_.toFixed(2);
                                }
                            });
                        });
                            ...
                            cart.forEach(cartItem => {
                                if (cartItem.name === product.name) {
                                    if (cartItem.quantity > 1) {
                                        ...
                                        let costoTotalDecreciente= document.querySelector('input[name="costo_total"]').value;
                                        let sumTotal_ = parseFloat(costoTotalDecreciente) - parseFloat(cartItem.price)
                                        document.querySelector('input[name="costo_total"]').value =sumTotal_.toFixed(2);
                            ...
                            cart.forEach(cartItem => {
                                if (cartItem.name === product.name) {
                                   // cartTotal -= parseInt(cartItemDom.querySelector(".cart_item_price").innerText);
                                    ...
                                    let TotalSustraccion = parseInt(cartItemDom.querySelector(".cart_item_quantity").innerText) *parseFloat(cartItemDom.querySelector(".cart_item_price").innerText);

                                    let costoTotalRemove = document.querySelector('input[name="costo_total"]').value;
                                    let costoRestablecido = parseFloat(costoTotalRemove) - TotalSustraccion;
                                    document.querySelector('input[name="costo_total"]').value =costoRestablecido.toFixed(2);

                                    console.log(costoTotalRemove)
                                    console.log(TotalSustraccion)

                                    addtocartbtnDom.innerText = "Añadir";
