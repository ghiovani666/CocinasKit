                            ...
                            <div class="product_attributes  margin-bottom-0">
                                ...
                                <fieldset style="height: 277px;">
                                    <div id="attributes">
                                        ...
                                        <div class="col-sm-4" id="html_imagen_color" style="text-align: center;">
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
                        ...
                        <div class="col-xs-12 col-md-4">
                            ...
                            <div class="product_attributes margin-bottom-10">
                                ...
                                <fieldset style="height: 50px;">
                                    ...
                                    <div class="col-4 col-sm-3">
                                        <label style="text-align: center;margin-top: 14px;font-size: 16px;"> <strong
                                                id="valorEnzimera_"> € 00.00</strong> </label>
                                    </div>
                                </fieldset>
                            </div>
                            ...
                            <div class="product_attributes margin-bottom-10">
                                ...
                                <fieldset style="height: 50px;">
                                    ...
                                    <div class="col-4 col-sm-3">
                                        <label
                                            style="text-align: center;margin-top: 14px;font-size: 14px;display: table-row;">
                                            <strong id="valorCopete_"> € 00.00</strong> </label>
                                        <label class="radio-img">
                                            <input type="radio" name="radio_copete"/>
                                            <img style="width: 40px;" id="valorCopete_imagen" onclick="openModalCopete()" src="#">
                                        </label>
                                    </div>
...
$(document).ready(function() {
    ...
    console.log(<?php echo (count($modeloPuerta)!=0?$modeloPuerta[0]->id:'');?>)
...
function imagenModalCompleto(url_image){
    $('#valorCopete_imagen').attr('src', url_image);
    $('#zoomImgModal').attr('src', url_image);
    $('#imagenGeneral').val(url_image);
}

function openModalCopete(url_image){
    $('#zoomImgModal').attr('src', $('#imagenGeneral').val());
    $('#imagenModal').modal(true)
