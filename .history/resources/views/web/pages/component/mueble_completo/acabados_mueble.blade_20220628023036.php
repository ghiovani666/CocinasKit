        ...
        <fieldset class="attribute_fieldset"
            ...
            <div id="attributes">
                ...
                <div class="margin-bottom-40">
                    ...
                    <div class="col-sm-12" style="display: flex;">
                        <label for="layout" style="color: #000000;font-weight: bold;">PUERTAS:</label><em class="cocinakit_help_icon icon-question circle-icon" original-title="Seleccione Pruerta"></em></label>
