        ...
        <fieldset class="attribute_fieldset"
            ...
            <div id="attributes">
                ...
                <div class="row margin-bottom-30">
                    <div class="col-sm-3">
                        <label for="size" style="display: flex;" >Ancho<em class="cocinakit_help_icon icon-question circle-icon"></em></label>
                ...
                <div class="margin-bottom-40">
                    ...
                    <div class="col-sm-12" style="display: flex;">
                    <label for="layout" style="color: #000000;font-weight: bold;">PUERTAS:</label>
                        <input style="margin-left: 47px;" class="form-check-input" style="margin-right: 10px;"
                            type="radio" name="txt_apertura" value="4">
                        <label class="form-check-label" style="margin-left: 10px;" for="txt_apertura">
                            Abatible
