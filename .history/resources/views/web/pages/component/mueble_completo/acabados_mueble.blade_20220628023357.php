            ...
            <div id="attributes">
                ...
                <div class="margin-bottom-40">
                    ...
                    <div style="display: flex;">
                        <label for="layout" style="color: #000000;font-weight: bold;">PUERTAS </label><em class="cocinakit_help_icon icon-question circle-icon" original-title="Seleccione puerta"></em>
                        <p class="cocinakit_help_text" style="display: none;"> Seleccione el número de puertas</p>
                    </label>
                        <input style="margin-left: 20px;" class="form-check-input" style="margin-right: 10px;"
                            type="radio" name="txt_puertas" value="1">
                        <label class="form-check-label" style="margin-left: 10px;" for="txt_puertas_">
                            1 Puerta
                        </label>

                        <input style="margin-left: 30px;" class="form-check-input" style="margin-right: 10px;"
