                        ...
                        <form id="form1" action="{{url('/')}}/checkout" method="get">
                            ...
                            <div class="subtotal cf">
                                <ul>
                                    ...
                                    <li class="totalRow">
                                        <button type="submit" class="btn btn-danger"  onclick="redirecShop(33);" style="font-size: 25px;"> <i class="glyphicon glyphicon-chevron-left" aria-hidden="true"></i> Regresar</button>
