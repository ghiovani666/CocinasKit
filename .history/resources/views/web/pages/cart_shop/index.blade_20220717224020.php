                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content" style="border: unset !important;">
                            ...
                            <div class="modal-body">
                                ...
                                <p class="margin-bottom-30"> {{count($precioAdicional)!=0?$precioAdicional[2]->precio:''}} </p>
                                ...
                                <div class="alert alert-primary" role="alert"
                                    ...
                                    <label for="" style="padding-left: 12px;font-size: 16px;color:#ffffff;">
                                        Usted ya tiene un Descuento del % {{(Auth::user()->oferta_precio)?Auth::user()->oferta_precio:''}} . Monto a pagar: <strong id="valorDescuento"></strong></label>
                                    @else
                                    <label for="" style="padding-left: 12px;font-size: 16px;color:#ffffff;">
...
$(document).ready(function() {
    ...
    let valorDel = parseFloat($('#txt_monto_total_').text().replace(",", ""))-(parseFloat( {{(Auth::user()->oferta_precio)?Auth::user()->oferta_precio:''}})/100)*parseFloat($('#txt_monto_total_').text().replace(",", ""));
   $('#valorDescuento').text('€ '+valorDel)
