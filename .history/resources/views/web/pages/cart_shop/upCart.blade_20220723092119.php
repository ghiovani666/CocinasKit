...
<div class="table-responsive cart_info">
    <div class="wrap cf">
                        ...
                        <div class="cartSection">
                            ...
                            <ul>
                                <li><i class="fa fa-check" aria-hidden="true"></i> Codigo:
                                    {{$cartItem->id}}</li>
                                <li><i class="fa fa-check" aria-hidden="true"></i> Precio procesado: €
                                    {{$cartItem->price}}</li>
        ...
        <ul style="text-decoration: none;display: flex;margin-left: 20px;">
            <li>
                @if (Cart::count() < 4) <input class="form-check-input" type="checkbox"
                    ...
                    @elseif(Cart::count() >= 4 && Cart::count() <= 6) <input class="form-check-input" type="checkbox"
                        value="{{ $precioAdicional[1]->precio }}" name="check_armado_mueble">
                        <label class="form-check-label" for="check_armado_mueble">
                            Transporte
                        ...
                        <input class="form-check-input" type="checkbox" value="{{ $precioAdicional[2]->precio }}"
            ...
            <li style="margin-left: 45px;">
                ...
                @if (Cart::count() < 4) <input class="form-check-input" type="checkbox"
                    ...
                    @elseif(Cart::count() >= 4 && Cart::count() <= 6) <input class="form-check-input" type="checkbox"
                        value="{{ $precioAdicional[4]->precio }}" name="check_armado_mueble">
                        <label class="form-check-label" for="check_armado_mueble">
                            Instalación
                        ...
                        <input class="form-check-input" type="checkbox" value="{{ $precioAdicional[5]->precio }}"
                            name="check_armado_mueble">
                        <label class="form-check-label" for="check_armado_mueble">
                            Instalación
