...
@if (Auth::user())
                                    ...
                                    <label for="" style="padding-left: 12px;font-size: 16px;color:#ffffff;">
                                        Usted ya tiene un Descuento del % {{Auth::user()->oferta_precio}} . Monto a pagar: <strong id="valorDescuento"></strong></label>
                                    @else
                                    <label for="" style="padding-left: 12px;font-size: 16px;color:#ffffff;">
...
$(document).ready(function() {
    ...
    if({{Auth::user()->oferta_precio}}){
        let valorDel = parseFloat($('#txt_monto_total_').text().replace(",", ""))-(parseFloat( {{Auth::user()->oferta_precio}})/100)*parseFloat($('#txt_monto_total_').text().replace(",", ""));
