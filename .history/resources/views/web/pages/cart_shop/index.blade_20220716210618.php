                        ...
                        <div class="subtotal cf">
                            <ul>
                                ...
                                <li class="totalRow">
                                    ...
                                    <button type="submit" class="btn btn-info" onclick="openModalCuenta()" style="font-size: 25px;">Enviar
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content" style="border: unset !important;">
                            <div class="alert" role="alert" style="display: flex;background: #13756f;color: white;">
                                ...
                                </svg> <label for="" style="padding-left: 12px;font-size: 16px;color: white;">Se ha procesado las caracteristicas del producto</label>
                            </div>
