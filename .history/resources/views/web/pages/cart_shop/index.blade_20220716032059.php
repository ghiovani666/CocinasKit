                    ...
                    <div class="wrap cf">
                        ...
                        <form id="form1" action="{{url('/')}}/checkout" method="get">
                            <div class="promoCode">
                                ...
                                <div class="form-check" style="display: flex;width: 120%;">
                                    <input class="form-check-input" style="margin-right: 12px;" type="checkbox"
                                        value="3" name="txt_pago_2" required>
                            ...
                            <a href="javascript:history.back()" class="btn btn-danger"> <i
                                                class="glyphicon glyphicon-chevron-left" aria-hidden="true"></i> <label
                                                for="monto_text" style="font-size: 25px;">Regresar</label></a>
                                                
                                        <a class="btn btn-info"> <label for="monto_text" style="font-size: 25px;">Enviar
                                                Pago</label> <i class="fa fa-check" aria-hidden="true"></i></a>
                        </form>
