                    ...
                    <div class="wrap cf">
                        ...
                        <div class="subtotal cf">
                            <ul>
                                ...
                                <li class="totalRow final margin-bottom-30">

                                <input type="hidden" value="{{Cart::subtotal()}}" id="txt_monto_total_s" name="txt_monto_total_s" />

                                    <span class="label">Total €</span>
                                <span class="value"><span id="txt_monto_total_"> {{Cart::subtotal()}}</span></span>
                                </li>
                                <li class="totalRow">
                                    <a href="{{ URL::previous() }}">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content" style="border: unset !important;">
                            ...
                            <div class="modal-body">
                                ...
                                <p class="margin-bottom-30"> Madrid: 55151-25151-5151-51515</p>
...
$("input[name=check_instalacion_mueble]").change(function(e) {
    ...
    let rest1 = parseFloat($('#txt_monto_total_s').val()) ;

console.log($('#txt_monto_total_s').val()+50)

    if ($("input[name=check_instalacion_mueble]").prop('checked')) {
        let rest1 = parseFloat($('#txt_monto_total_s').val()) + parseFloat($(this).val());
        $('#txt_monto_total_').text(rest1.toFixed(2))
    } else {
        let rest2 = parseFloat($('#txt_monto_total_s').val()) - parseFloat($(this).val());
        $('#txt_monto_total_').text(rest2.toFixed(2))
    }
});
