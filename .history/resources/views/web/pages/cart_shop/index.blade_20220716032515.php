                        ...
                        <form id="form1" action="{{url('/')}}/checkout" method="get">
                            ...
                            <div class="subtotal cf">
                                <ul>
                                    ...
                                    <li class="totalRow">
                                        <button type="submit" class="btn btn-danger"  onclick="myJsFunc(); return history.back();" style="font-size: 25px;"> <i class="glyphicon glyphicon-chevron-left" aria-hidden="true"></i> Regresar</button>
