                        ...
                        <div class="promoCode">
                            ...
                            <!-- <div class="form-check" style="display: flex;">
                                    <input class="form-check-input" style="margin-right: 12px;" type="radio" value="1"
                                        name="check_armado_mueble" required>
                                    <label class="form-check-label" for="check_armado_mueble">Pagar por Paypal
                                    </label>
                                    <input class="form-check-input" style="margin-right: 12px;" type="radio" value="2"
                                        name="check_armado_mueble">
                                    <label class="form-check-label" for="check_armado_mueble"> Pagar por Deposito Bancario
                                    </label>
                                </div>
                                <hr> -->
                        ...
                        ?>
                            ...
                            <div class="form-check" style="display: flex;width: 140%;">
                                <input class="form-check-input" style="margin-right: 12px;" type="checkbox"
                                    value="{{count($precioAdicional)!=0?$precioAdicional[0]->precio:0}}"
                                    name="check_armado_mueble">
                                <label class="form-check-label" for="check_armado_mueble" style="padding-top: 10px;"> Armado
                                ...
                                <label class="form-check-label" for="check_instalacion_mueble"
...
// :::::::::::::::::::::::: HACER PAGO CON 2 CHECKBOX :::::::::::::::::::::::::::::


$("input[type=checkbox][name=check_armado_mueble]").change(function() {
    $('#txt_pagos').val($('input[name="check_armado_mueble"]:checked').val()) // Pago con paypal
});

$("input[name=check_instalacion_mueble]").change(function(e) {
    let val_1 = $(this).val();
    if ($("input[name=check_instalacion_mueble]").prop('checked')) {
        $('#txt_monto_total_').text(parseFloat($('#txt_monto_total_').text())+parseFloat(val_1))
    } else {
        $('#txt_monto_total_').text(parseFloat($('#txt_monto_total_').text())+parseFloat(00.00))
    }
    ...
    // $('#txt_persona').val($('input[name="check_instalacion_mueble"]:checked').val())
    // if (this.value == 4) {
    //     $('#monto_text1').text('70.00')
    //     $('#txt_monto_total_').text(parseFloat(valor) + 70.00)
    //     $('#monto_pagar').val(parseFloat(valor) + 70.00)
    // } else {
    //     $('#monto_text1').text('00.00')
    //     $('#txt_monto_total_').text(parseFloat(valor))
