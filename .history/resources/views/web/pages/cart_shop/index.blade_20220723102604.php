                        ...
                        <ul style="text-decoration: none;display: flex;margin-left: 20px;">
                            <li>
                                @if (Cart::count() < 4) <input class="form-check-input" type="checkbox"
                                    ...
                                    @elseif(Cart::count() >= 4 && Cart::count() <= 6) <input class="form-check-input"
                ...
                <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content" style="border: unset !important;">
                            ...
                            <a href="{{ route('checkout-page') }}" type="submit" class="btn btn-primary checkout-btn">REGISTRAR PEDIDO</a>
