                        ...
                        ?>
                            ...
                            <div class="form-check" style="display: flex;width: 120%;">
                                <input class="form-check-input" style="margin-right: 12px;" type="checkbox"
                                    value="{{count($precioAdicional)!=0?$precioAdicional[0]->precio:''}}"
                                    name="txt_pago_1">
                                ...
                                <input class="form-check-input" style="margin-right: 12px;" type="checkbox"
                                    value="{{count($precioAdicional)!=0?$precioAdicional[1]->precio:''}}"
                                    name="txt_pago_2">
                                <label class="form-check-label" for="txt_pago_2" style="padding-top: 10px;">
                                    Instalación del mueble €
                                    {{count($precioAdicional)!=0?$precioAdicional[1]->precio:''}}
                                </label>
                            </div>
