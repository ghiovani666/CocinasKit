            ...
            <div id="updateDiv">
                ...
                <div class="table-responsive cart_info">
                    <div class="wrap cf">
                                ...
                                <li class="items odd">
                                    ...
                                    <div class="infoWrap">
                                        ...
                                        <div class="cartSection removeWrap">
                                            <a  href="{{url('/cart/remove')}}/{{$cartItem->rowId}}"> @include('web.pages.cart_shop.ajax.icon_eliminar')</a>
                                        </div>
                                    </div>
                                </li>
                                <?php $count++;?>
                        ...
                        <form id="form1" action="{{url('/')}}/checkout" method="get">
                            <div class="promoCode">
                                ...
                                <div class="form-check" style="display: flex;width: 120%;">
                                    <input class="form-check-input" style="margin-right: 12px;" type="checkbox" value="3"
                                        name="txt_pago_2" required>
                                    <label class="form-check-label" for="txt_pago_2" style="padding-top: 10px;"> Armado del mueble € 180
                                    </label>
                                    <input class="form-check-input" style="margin-right: 12px;" type="checkbox" value="4"
                                        name="txt_pago_2">
                                    <label class="form-check-label" for="txt_pago_2" style="padding-top: 10px;"> Instalación del mueble € 360
                                    </label>
                                </div>
                            ...
                            <div class="subtotal cf">
                                <ul>
                                    ...
                                    <li class="totalRow">
                                        <button type="submit" class="btn btn-danger" style="font-size: 25px;">Enviar Pago</button>
                                    ...
                                    <li class="totalRow">
                                        ...
                                        <button type="submit" class="btn btn-info" style="font-size: 25px;">Enviar Pago</button>
