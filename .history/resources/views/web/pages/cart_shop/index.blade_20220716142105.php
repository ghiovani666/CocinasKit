...
$("input[type=checkbox][name=txt_pago_1]").change(function() {
    $('#txt_pagos').val($('input[name="txt_pago_1"]:checked').val()) // Pago con paypal
});

$("input[type=checkbox][name=check_instalacion_mueble]").change(function(e) {
    let val = $(this).val();

    if ($("input[type=checkbox][name=check_instalacion_mueble]").prop('checked')) {
        console.log(val);
    } else {
        console.log('no hay');
    }
