                                        ...
                                        <div class="cartSection">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <input class="form-check-input"  value="{{count($precioAdicional)!=0?$precioAdicional[0]->precio:0}}"
                                                        name="check_armado_mueble">
                                                    <label class="form-check-label" for="check_armado_mueble" >
                                                        Armado
                                                        del mueble €
                                                        {{count($precioAdicional)!=0?$precioAdicional[0]->precio:0}}
                                                    </label>
                                                </li>
                                                ...
                                                <li>
                                                    ...
                                                    <input class="form-check-input" style="margin-right: 12px;"
                                                        type="checkbox"
