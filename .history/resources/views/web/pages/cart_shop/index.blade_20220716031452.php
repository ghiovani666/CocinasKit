                        ...
                        <form id="form1" action="{{url('/')}}/checkout" method="get">
                            ...
                            <div class="subtotal cf">
                                <ul>
                                    ...
                                    <li class="totalRow">
                                        <a type="submit" href="javascript:history.back()" class="btn btn-danger" style="font-size: 25px;"> <i class="glyphicon glyphicon-chevron-left" aria-hidden="true"></i> Regresar</a>
