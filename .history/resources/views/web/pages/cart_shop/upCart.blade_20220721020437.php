                                    ...
                                    <div class="infoWrap">
                                        ...
                                        <div class="cartSection">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    @if ($cartItem->qty < 4) <i class="fa fa-check" aria-hidden="true">
                                                        </i>
                                                        <input class="form-check-input" type="checkbox"
                                                            value="{{ $precioAdicional[0]->precio }}"
                                                        ...
                                                        @elseif($cartItem->qty >= 4 && $cartItem->qty <= 6) <i
                                                            class="fa fa-check" aria-hidden="true"></i>
                                                            <input class="form-check-input" type="checkbox"
                                                                value="{{ $precioAdicional[1]->precio }}"
                                                                name="check_armado_mueble">
                                                            <label class="form-check-label" for="check_armado_mueble">
                                                                Armado
                                                                del mueble €
                                                            ...
                                                            <input class="form-check-input" type="checkbox"
                                                                value="{{ $precioAdicional[2]->precio }}"
                                                                name="check_armado_mueble">
                                                            <label class="form-check-label" for="check_armado_mueble">
                                                                Armado
                                                                del mueble €
                                                ...
                                                <li>
                                                    ...
                                                    @if ($cartItem->qty < 4) <i class="fa fa-check" aria-hidden="true">
                                                        ...
                                                        <input class="form-check-input" type="checkbox"
                                                            value="{{ $precioAdicional[3]->precio }}"
                                                            name="check_armado_mueble">
                                                        <label class="form-check-label" for="check_armado_mueble">
                                                        Instalación
                                                            del mueble €
                                                            {{ $precioAdicional[3]->precio }}
                                                        </label>
                                                        @elseif($cartItem->qty >= 4 && $cartItem->qty <= 6) <i
                                                            class="fa fa-check" aria-hidden="true"></i>
                                                            <input class="form-check-input" type="checkbox"
                                                                value="{{ $precioAdicional[4]->precio }}"
                                                                name="check_armado_mueble">
                                                            <label class="form-check-label" for="check_armado_mueble">
                                                            Instalación
                                                                del mueble €
                                                            ...
                                                            <i class="fa fa-check" aria-hidden="true"></i>
                                                            <input class="form-check-input" type="checkbox"
                                                                value="{{ $precioAdicional[5]->precio }}"
                                                                name="check_armado_mueble">
                                                            <label class="form-check-label" for="check_armado_mueble">
                                                            Instalación
                                                                del mueble €
                        ...
                        <div class="modal-content" style="border: unset !important;">
                            ...
                            <div class="modal-body">
                                ...
                                <p class="margin-bottom-30">
                                    {{count($precioAdicional)!=0?$precioAdicional[2]->precio:''}} </p>
...
$(document).ready(function() {
    ...
    if($('#validar_precio').val()){
        let valorDel = parseFloat($('#txt_monto_total_').text().replace(",", "")) - (parseFloat($('#validar_precio').val()) / 100) * parseFloat($('#txt_monto_total_').text().replace(",", ""));
