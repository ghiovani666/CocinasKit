                                ...
                                <div id="attributes" style="margin-top: 25px;margin-left: 12px;">
                                    <div class="row margin-bottom-30">
                                        <?php 
                                                ...
                                                ?>
                                        @if(count($sizes1)!=0 && $sizes1[0]->largo!=0)
                                        <div class="col-sm-3">
                                        ...
                                        <?php 
                                                $sizes2 = DB::select("
                                                        ...
                                                        m.id_medida,
                                                        m.alto
                                                        FROM   medida m WHERE  m.id_imagen = ? and m.alto!=0 ORDER BY m.id_medida asc", [$Products[0]->id_imagen]);
                                                ?>
                                        @if(count($sizes2)!=0 && $sizes2[0]->alto!=0)
                                        <div class="col-sm-3">
                                ...
                                <div class="txt_modelo">
                                    ...
                                    <div style="display: flex;margin-left: 12px;">
                                        ...
                                        <label class="radio-img">
                                            <input type="radio" id="txt_imagen" name="txt_imagen"
