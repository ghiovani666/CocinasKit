                                ...
                                <form id="uploadForm">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-12">
                                            ...
                                            <h4 class="mt-3">APLICAR PARA TODOS LOS PRODUCTOS</h4>
                                            ...
                                            <div class="bg-gray py-2 px-3 mt-4">
                                                <h2 class="mb-0">
                                                    <label for="txt_price">Precio Oferta:</label>
...
function listarComboBox(id_producto) {
    $.ajax({
        type: 'get',
        dataType: 'html',
        url: 'mueble_colores_listar_combobox',
...
<!-- <script src="{{asset('template_admin/js/mueble_colores_files.js')}}"></script> -->
