                                        ...
                                        <div class="col-12 col-sm-12">
                                            ...
                                            <div class="questions">
                                                <div class="questions__question">
                                                    <input type="radio" name="lbl_estado_oferta" id="answer-1" value="1">
                                                    <label for="answer-1" data-question-number="1">Sí</label>
                                                </div>
                                                <div class="questions__question" style="margin-left: 45px">
                                                    <input type="radio" name="lbl_estado_oferta" id="answer-2" value="0">
                                            ...
                                            <div class="bg-gray py-2 px-3 mt-4">
                                                <h5 class="mb-0">
                                                    <label for="lbl_price">Ingrese oferta en porcentaje %:</label>
                                                    <input type="text" class="form-control" name="lbl_price" required>
                                                </h5>
                                            </div>
...
function openModalCrud(id_producto, isValues) {
    ...
    if (isValues == "ELIMINAR") {
        ...
        if (isValues == 'CREAR') {
            ...
            $('input[name=lbl_price]').val("");
            $('input:radio[name="lbl_estado_oferta"]').filter('[value=1]').attr('checked', true);
