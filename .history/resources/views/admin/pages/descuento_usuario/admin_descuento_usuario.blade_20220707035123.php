        ...
        if (id_producto) {
            ...
            axios.post('descuento_usuario_editar',
                ...
                if (response.data[0]) {
                    ...
                    $('input[name=lbl_oferta_precio]').val(response.data[0].precio_oferta);
                    $('input:radio[name="lbl_oferta_estado"]').filter('[value=' + response.data[0].estado_oferta + ']').attr('checked', true);
