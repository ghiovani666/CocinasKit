    ...
    <div class="content" style="text-align: -webkit-right;">
        <div class="col-2">
            <a href="javascript:void(0)" onclick="openModalCrud(false,'CREAR')"
                class="btn btn-block bg-gradient-success disableEliminar"><i class="far fa-plus-square"></i> Crear</a>
        </div>
    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-12">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="email" class="form-control" name="lbl_email">
                                            </div>
                                            <div class="col-12">
                                                <label for="lbl_name">Password:</label>
                                                <input type="text" class="form-control" name="lbl_password">
                                            </div>
                                            <div class="col-12">
                                                <label for="lbl_name">Telefono:</label>
                                                <input type="text" class="form-control" name="lbl_telefono">
                                            </div>
                                            <div class="col-12">
                                                <label for="lbl_name">Ubicacion:</label>
                                                <input type="text" class="form-control" name="lbl_ubicacion">
                                            </div>
                                            ...
                                            <div class="questions">
                                                <div class="questions__question">
                                                    <input type="radio" name="lbl_oferta_estado" id="answer-1" value="1">
                                                    <label for="answer-1" data-question-number="1">Sí</label>
                                                </div>
                                                <div class="questions__question" style="margin-left: 45px">
                                                    <input type="radio" name="lbl_oferta_estado" id="answer-2" value="0">
                                            ...
                                            <div class="bg-gray py-2 px-3 mt-4">
                                                <h5 class="mb-0">
                                                    <label for="lbl_oferta_precio">Ingrese oferta en porcentaje %:</label>
                                                    <input type="text" class="form-control" name="lbl_oferta_precio" required>
                                                </h5>
                                            </div>
...
function openModalCrud(id_producto, isValues) {
    ...
    if (isValues == "ELIMINAR") {
        ...
        if (isValues == 'CREAR') {
            ...
            $('input[name=lbl_oferta_precio]').val("");
            $('input:radio[name="lbl_oferta_estado"]').filter('[value=1]').attr('checked', true);
        ...
        if (id_producto) {
            ...
            axios.post('descuento_usuario_editar',
                ...
                if (response.data[0]) {
                    ...
                    $('input[name=lbl_name]').val(response.data[0].name);
                    $('input[name=lbl_email]').val(response.data[0].email);
                    $('input[name=lbl_password]').val(response.data[0].password);
                    $('input[name=lbl_telefono]').val(response.data[0].telefono);
                    $('input[name=lbl_ubicacion]').val(response.data[0].ubicacion);
                    $('input[name=lbl_oferta_precio]').val(response.data[0].oferta_precio);
                    $('input:radio[name="lbl_oferta_estado"]').filter('[value=' + response.data[0].oferta_estado + ']').attr('checked', true);
