    ...
    if (isValues == "ELIMINAR") {
        ...
        if (id_producto) {
            ...
            axios.post('composicion_oferta_editar',
                ...
                $('input[name=id_image1]').val(response.data[0].id_imagen);
                $('input[name=id_image2]').val(response.data[0].id_imagen);
                $('input[name=id_image3]').val(response.data[0].id_imagen);
                $('input[name=id_image4]').val(response.data[0].id_imagen);
                $('input[name=id_image5]').val(response.data[0].id_imagen);
