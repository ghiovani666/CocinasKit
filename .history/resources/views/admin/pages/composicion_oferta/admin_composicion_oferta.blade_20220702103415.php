                                    ...
                                    <div class="col-12 col-sm-6">
                                        ...
                                        <div class="mt-4">
                                            <div class="btn btn-primary btn-lg btn-flat">
                                                <button  id="btn_sumit"><i class="fas fa-save fa-lg mr-2"></i> GUARDAR</button>
                                            </div>
                                            <div class="btn btn-default btn-lg btn-flat">
                                                <button type="button"  data-dismiss="modal"><i class="fas fa-times-circle fa-lg mr-2"></i> CERRAR</button>
                                            </div>
                                        </div>
