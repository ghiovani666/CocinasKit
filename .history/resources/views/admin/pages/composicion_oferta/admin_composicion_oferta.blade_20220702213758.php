                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                ...
                                                <div class="select2-purple">
                                                    ...
                                                    <select name="nameColor[]" multiple class="form-control nameColor <!-- @error('authors') is-invalid @enderror -->">
                                                        @foreach ($cbColores as $items)
                                                        <option value="{{ $items->id }}" {{ $items->id == $items->id_color ? 'selected' : '' }}>{{ $items->name_color }}</option>
                                                        @endforeach
                                                    </select>
...
var data2 = [
  ...
  $(".nameColor").select2({
                ...
                $('input[name=id_image0]').val(response.data[0][0].id_imagen);
                $('input[name=id_image1]').val(response.data[0][1].id_imagen);
                $('input[name=id_image2]').val(response.data[0][2].id_imagen);
                $('input[name=id_image3]').val(response.data[0][3].id_imagen);
                $('input[name=id_image4]').val(response.data[0][4].id_imagen);
                $('input[name=id_image5]').val(response.data[0][5].id_imagen);

                $('img[id=blah_0]').attr('src', response.data[0][0].url_image);
                $('img[id=blah_1]').attr('src', response.data[0][1].url_image);
                $('img[id=blah_2]').attr('src', response.data[0][2].url_image);
                $('img[id=blah_3]').attr('src', response.data[0][3].url_image);
                $('img[id=blah_4]').attr('src', response.data[0][4].url_image);
                $('img[id=blah_5]').attr('src', response.data[0][5].url_image);


                $('textarea[name=txt_descripcion]').val(response.data[0][0].pro_info);
                $('input[name=txt_price]').val(response.data[0][0].price);
