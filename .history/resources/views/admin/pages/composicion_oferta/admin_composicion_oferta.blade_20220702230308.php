                                        ...
                                        <div class="col-12 col-sm-6">
                                                ...
                                                <div class="select2-purple">
                                                    <select name="nameColor[]" multiple
                                                        ...
                                                        <option value="{{ $items->id }}"
                                                            {{ $items->id == $items->id_color ? 'selected' : '' }}>
                                            ...
                                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                <div class="select2-purple">
                                                    <select name="nameTirador[]" multiple
                                                        ...
                                                        <option value="{{ $items->id }}"
                                                            {{ $items->id == $items->id_tirador ? 'selected' : '' }}>
                                                            {{ $items->nombre }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                <div class="select2-purple">
                                                    <select name="nameEnzimera[]" multiple
                                                        ...
                                                        <option value="{{ $items->id }}"
                                                            {{ $items->id == $items->id_enzimera ? 'selected' : '' }}>
                                                            {{ $items->nombre }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="questions">
                                                ...
                                                <div class="questions__question" style="margin-left: 45px">
                                                    <input type="radio" name="txt_copete" id="answer-2">
                                                    <label for="answer-2" data-question-number="2" value="0">No</label>
                                                </div>
                                            </div>
    ...
    if (isValues == "ELIMINAR") {
        ...
        if (id_producto) {
            ...
            axios.post('composicion_oferta_editar',
               ...
               // $('input[name=txt_copete]:checked').val("1");

                $('input:radio[name="txt_copete"]').filter('[value='+response.data[0].copete+']').attr('checked', true);
