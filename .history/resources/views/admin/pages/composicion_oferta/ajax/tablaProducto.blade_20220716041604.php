        ...
        <tr>
            ...
            <td>
                <a href="javascript:void(0)"
                    onclick="openModalCrud({{ $rows->id }},'FICHA',{{ $rows->id }},'{{ $rows->pro_name }}','{{ $rows->url_image }}',{{ $rows->id_imagen }})">@include('admin.pages.mueble_completo.ajax.icon_ficha')</a>
            </td>
            <td>
                <a href="javascript:void(0)"
                    onclick="openModalCrud({{ $rows->id }},'ASIGNAR',{{ $rows->id }},'{{ $rows->pro_name }}','{{ $rows->url_image }}',{{ $rows->id_imagen }})">@include('admin.pages.mueble_completo.ajax.icon_suma')</a>
            </td>
            <td>
