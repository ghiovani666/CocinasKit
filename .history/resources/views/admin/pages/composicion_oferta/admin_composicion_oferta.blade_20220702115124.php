    ...
    axios.post('composicion_oferta_crear',
        ...
        if (response.data.state == "error") {
            ...
            if (response.data.src) {
                $('img[name=image0]').attr('src', response.data.src);
            }
...
function openModalCrud(id_producto, isValues) {
    ...
    if (isValues == "ELIMINAR") {
        ...
        $('input[name=txt_id_gallery]').val(id_producto)
        ...
        if (id_producto) {
            ...
            axios.post('composicion_oferta_editar',
                ...
                console.log(response.data[0].url_image);

                // $('input[name=image0]').val(response.data[0].id_producto);
                $('img[name=image0]').attr('src', response.data[0].url_image);
                $('img[name=image1]').attr('src', response.data[1].url_image);
                $('img[name=image2]').attr('src', response.data[2].url_image);
                $('img[name=image3]').attr('src', response.data[3].url_image);
                $('img[name=image4]').attr('src', response.data[4].url_image);
                $('img[name=image5]').attr('src', response.data[5].url_image);
                $('img[name=image6]').attr('src', response.data[6].url_image);
