                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <?php  
                                                ...
                                                ?>
                                            <div class="col-12" style="margin-bottom: 15px;">
                                                <label for="">Seleccione un Modelo de Puerta </label>

                                                <select name="txt_id_modelo_puerta" class="form-control " required>
...
$('#uploadForm').on('submit', function(e) {
    ...
    axios.post('mueble_regleta_crear',
        formData, {
            headers: {
...
function openModalCrud(id_producto, isValues) {
    ...
    if (isValues == "ELIMINAR") {
        ...
        if (id_producto) {
            ...
            let formData = new FormData();
            formData.append('id_producto', id_producto)
            axios.post('mueble_regleta_editar',
                formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data'
                    }
