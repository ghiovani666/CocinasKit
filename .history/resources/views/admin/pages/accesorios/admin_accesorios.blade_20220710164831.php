    ...
    <div class="content" style="text-align: -webkit-right;">
        <div class="col-2">
            <a href="javascript:void(0)" onclick="openModalCrud(false,'CREAR',null,null,null,null)"
                class="btn bg-gradient-success"><i class="far fa-plus-square"></i> Crear</a>
        </div>
    </div>
                                        ...
                                        <div class="col-12 col-sm-5">
                                            ...
                                            <div class="col-12"
                                                ...
                                                <div class="col-3">
                                                    ...
                                                    <select name="txt_largo_" id="txt_largo_" class="form-control">
                                            ...
                                            <div class="col-12" style="display: flex;margin-top: 45px;">
                                                ...
                                                <div class="col-6">
                                                    <label for="file1">
                                                        <img id="txt_src_imagen"
                                                            src="/img/mc_admin/btn_agregar_principal.jpg"
                                                            class="product-image" alt="Product Image"
...
$('#uploadForm').on('submit', function(e) {
    ...
    if ($('#file0').val().length > 0) {
        ...
        alert('Seleccione una imagen principal!')


});


function openModalCrud(id_producto, isValues, id_item, pro_name, url_image, id_imagen) {
    ...
    if (isValues == "ELIMINAR") {
        ...
        axios.post('accesorios_editar_medida',
            ...
            if (response.data[0]) {
                ...
                $("select[name=txt_largo_]").val(response.data[0].largo);
