...
<div class="col-12" style="display: flex;margin-top: 12px;">
    ...
    <label for="lbl_name" class="check_ShowHide" style="margin-left: 20px;margin-top: 2px;">Todos:</label>
    <input type="checkbox" class="check_ShowHide" id="check_5" name="check_5" style="width: 17px;height: 33px;margin-left: 10px;" value="2">
</div>
<div class="btn-group btn-group-toggle" data-toggle="buttons">
    <div class="select2-purple">
        <select name="nameColorCostado[]" multiple
            class="form-control nameColorCostado">
...
<div class="col-12" style="display: flex;margin-top: 12px;">
    ...
    <label for="lbl_name" class="check_ShowHide" style="margin-left: 20px;margin-top: 2px;">Todos:</label>
    <input type="checkbox" class="check_ShowHide" id="check_6" name="check_6" style="width: 17px;height: 33px;margin-left: 10px;" value="2">
</div>
<div class="btn-group btn-group-toggle" data-toggle="buttons">
    <div class="select2-purple">
        <select name="nameColorRegleta[]" multiple
            class="form-control nameColorRegleta">
