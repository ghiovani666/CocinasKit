...
<div class="content-wrapper">
    ...
    <div class="content" style="text-align: -webkit-right;">
        <div class="col-2">
            <a href="javascript:void(0)" onclick="openModalCrud(false,'CREAR',null,null,null,null)"
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-3">
                    <select name="" id="menu_item" class="form-control" required></select>
                </div>
            </div>
            <div class="row">
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="txt_tituloModal">ELEMENTO DECORATIVO</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-5">
                                            ...
                                            <div class="col-12"
                                                ...
                                                <div class="col-3">
                                                    ...
                                                    <select name="txt_ancho_" id="txt_ancho_" class="form-control">
                                                        <option title="0 cm" value="0">0 cm</option>
                                            ...
                                            <div class="col-12" style="display: flex;">
                                                <div class="col-3">
                                                    <label for="lbl_name">Izquierda (I)</label>
                                                    <input type="checkbox" id="check_izquierda" name="check_izquierda"
                                                        class="form-control" value="1">
                                                </div>
                                                <div class="col-3">
                                                    <label for="lbl_name">Derecha (D)</label>
                                                    <input type="checkbox" id="check_derecha" name="check_derecha"
                                                        class="form-control" value="1">
                                                </div>
                                                <div class="col-3">
                                                    <label for="lbl_name" style="width: 100px">2 Puertas (2P)</label>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-12">
                                            ...
                                            <div class="col-12" style="display: flex;">
                                                <div class="col-3">
                                                    <label for="lbl_name">Izquierda (I)</label>
                                                    <input type="checkbox" id="check_izquierda_" name="check_izquierda"
                                                        class="form-control" value="1">
                                                </div>
                                                <div class="col-3">
                                                    <label for="lbl_name">Derecha (D)</label>
                                                    <input type="checkbox" id="check_derecha_" name="check_derecha"
                                                        class="form-control" value="1">
                                                </div>
                                                <div class="col-3">
                                                    <label for="lbl_name" style="width: 100px">2 Puertas (2P)</label>
                                                    <input type="checkbox" id="check_doble_" name="check_doble"
                                                        class="form-control" value="1">
                                                </div>
                                            </div> -->
    ...
    <!-- Modal de Asignar Colores-->
    <div class="modal fade" id="modalOpenAsignar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="txt_tituloModal">ASIGNAR COLORES</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="row" style="text-align: center;display: initial;">
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body" id="dataProductoPuertas"></div>
                            <!-- /.card-body -->
                        </div>
                        <!-- /.card -->
                    </div>
    ...
    <!-- Modal de Ficha-->
    <div class="modal fade" id="modalOpenFicha" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="txt_tituloModal">APLICANDO FICHA</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <section class="content">
                        ...
                        <div class="card card-solid">
                            <div class="card-body">
                                <form id="saveService">
                                    <input type="hidden" name="txt_id_producto_ficha_tecnica" />
...
function listarDataTable(id_categoria, isValues) {
    ...
    $.ajax({
        type: 'get',
        dataType: 'html',
        url: 'elemento_decorativo_listar',
        data: {
...
function listarComboBox(id_producto) {
    $.ajax({
        type: 'get',
        dataType: 'html',
        url: 'elemento_decorativo_listar_combobox',
...
$('#uploadForm').on('submit', function(e) {
    ...
    axios.post('elemento_decorativo_crear',
        formData, {
            headers: {
...
function openModalCrud(id_producto, isValues, id_cat, pro_name, url_image, id_imagen) {
// 
    ...
    if (isValues == "ELIMINAR") {
        ...
        $('img[id=blah_1]').attr('src', url_image);
        $('input[name=txt_mueble_2]').val(pro_name);
        $('input[name=txt_id_imagen_]').val(id_imagen);
        $('input[name=txt_id_producto_]').val(id_producto);

    } else if (isValues == "FICHA") {
        $('#modalOpenFicha').modal('show')
        $('input[name=txt_id_producto_ficha_tecnica]').val(id_producto);
    ...
    } else if (isValues == "ASIGNAR") {
        $('#modalOpenAsignar').modal('show')
        listarDataTablePuerta(id_producto)
        ...
        if (isValues == 'CREAR') {
            ...
            $(".nameColor,.nameTirador,.nameUnero,.nameModelo,.nameColorCostado,.nameColorRegleta").val("").trigger("change");
            $(".nameColor,.nameTirador,.nameUnero,.nameModelo,.nameColorCostado,.nameColorRegleta").trigger("change");
        ...
        if (id_producto) {
            ...
            let formData = new FormData();
            formData.append('id_producto', id_producto)
            axios.post('elemento_decorativo_editar',
                formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data'
                    }
...
$('#menu_itemsRegistrar').on('change', function(e) {
    // e.preventDefault();
    let isValues=e.target.value
    if(isValues==54){
        $('.hideCost1').show();
        $('.hideCost2').hide();
    }else{
...
$('#uploadFormMedida').on('submit', function(e) {
    ...
    axios.post('elemento_decorativo_crear_medida',
        formData, {
            headers: {
                'Content-Type': 'multipart/form-data'
            }
...
function listar_medidas(id_producto) {
    $.ajax({
        type: 'get',
        dataType: 'html',
        url: 'elemento_decorativo_listar_medidas',
        data: "id_producto=" + id_producto,
        success: function(response) {
    ...
    if (isValues == "ELIMINAR") {
        Swal.fire({
            ...
            if (result.dismiss !== 'cancel') {
                ...
                axios.post('elemento_decorativo_eliminar_medida',
                    formData, {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
        ...
        let formData = new FormData();
        formData.append('id_medida', id_medida)
        axios.post('elemento_decorativo_editar_medida',
            formData, {
                headers: {
                    'Content-Type': 'multipart/form-data'
                }
...
// ::::::::::::::::::::::::::: ASIGNAR COLORES A PUERTAS :::::::::::::::::::::::::

function listarDataTablePuerta(id_producto) {
    $.ajax({
        type: 'get',
        dataType: 'html',
        url: 'mueble_puertas_listar_',
        data: "id_producto=" + id_producto,
        success: function(response) {
            $('#dataProductoPuertas').html(response);
        }
    });
}
// :::::::::::::::::::::::::::  FICHA TECNICA :::::::::::::::::::::::::
...
$('#saveService').on('submit', function(e) {
    e.preventDefault();
    let formData = new FormData(this);
    formData.append('id_producto', $("input[name=txt_id_producto_ficha_tecnica]").val())
    axios.post('listarDataTableInfoUpdate',
        formData, {
            headers: {
                'Content-Type': 'multipart/form-data'
            }
