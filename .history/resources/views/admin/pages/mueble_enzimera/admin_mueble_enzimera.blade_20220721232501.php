        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="txt_tituloModal">PRODUCTO</h5>
                                ...
                                <form id="uploadForm">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <hr>
                                            <div class="col-12" style="margin-bottom: 15px;">
                                                <input type="text" class="form-control" name="txt_precio" placeholder="Ingreso precio" required>
                                            </div>
...
$('#uploadForm').on('submit', function(e) {
    ...
    axios.post('mueble_enzimera_crear',
        formData, {
            headers: {
...
function openModalCrud(id_producto, isValues) {
    ...
    if (isValues == "ELIMINAR") {
        ...
        if (id_producto) {
            ...
            let formData = new FormData();
            formData.append('id_producto', id_producto)
            axios.post('mueble_enzimera_editar',
                formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data'
                    }
                ...
                if (response.data[0]) {
                    ...
                    $('input[name=txt_precio]').val(response.data[0].precio);
