                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="col-12">
                                                ...
                                                <div class="col-12" style="margin-top: 10px" id="txt_radio_1">
                                                    <label for="lbl_name">Opcion de mueble</label>
                                                    <select name="txt_mueble_1" id="txt_mueble_1" class="form-control">
                                                ...
                                                <div class="col-12" style="margin-top: 10px" id="txt_radio_2">
                                                    <label for="lbl_name">Escribe opcion de mueble</label>
                                                    <input type="text" class="form-control" name="txt_mueble_2"
                                                        id="txt_mueble_2" required />
                                                </div>
                                            ...
                                            <div class="col-12" style="display: flex;">
                                                <div class="col-3">
                                                    ...
                                                    <input type="checkbox" id="check_izquierda" name="check_izquierda" class="form-control"
                                                        value="first_checkbox">
                                                </div>
                                                <div class="col-3">
                                                    <label for="lbl_name">Derecha:</label>
                                                    <input type="checkbox" id="check_derecha" name="check_derecha" class="form-control"
                                                        value="first_checkbox">
                                                </div>
                                                <div class="col-3">
                                                    <label for="lbl_name">2 Puertas:</label>
                                                    <input type="checkbox" id="check_doble" name="check_doble" class="form-control"
                                                        value="first_checkbox">
                                                </div>
                                            </div>
...
$('#menu_categoria').on('change', function(e) {
    ...
    funcionCategoria(id_categoria)

});


function funcionCategoria(id_categoria){
    $.ajax({
        type: 'get',
