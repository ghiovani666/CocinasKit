                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <label for="lbl_name" style="margin-bottom: 10px">Escribe la nueva
                                                    opcion del mueble:</label>
                                                <input type="text" class="form-control" name="lbl_name">

                                            </div>
                                            <div class="col-12" style="display: flex;margin-bottom: 10px">
                                                <div class="col-3">
                                            ...
                                            <label for="lbl_name" style="margin-bottom: 10px;margin-top: 45px">Apertura:</label>
