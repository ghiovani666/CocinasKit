    ...
    if (isValues == "ELIMINAR") {
        ...
        axios.post('mueble_completo_editar_medida',
            ...
            if (response.data[0]) {
                ...
                $('input:checkbox[id="check_izquierda_"]').filter('[value=' + response.data[0].apert_izquierda + ']').prop('checked', true);
                $('input:checkbox[id="check_derecha_"]').filter('[value=' + response.data[0].apert_derecha + ']').prop('checked', true);
                $('input:checkbox[id="check_doble_"]').filter('[value=' + response.data[0].apert_doble + ']').prop('checked', true);
