                                        ...
                                        <div class="col-12 col-sm-12">
                                            ...
                                            <div class="questions">
                                                <div class="questions__question">
                                                    <input type="radio" name="lbl_oferta_estado" id="answer-1"
                                                        value="1">
                                                    <label for="answer-1" data-question-number="1">Sí</label>
                                                </div>
                                                <div class="questions__question" style="margin-left: 45px">
                                                    <input type="radio" name="lbl_oferta_estado" id="answer-2"
                                                        value="0">
                                            ...
                                            <div class="bg-gray py-2 px-3 mt-4">
                                                <h5 class="mb-0">
                                                    <label for="lbl_oferta_precio">Ingrese oferta en porcentaje
                                                        %:</label>
