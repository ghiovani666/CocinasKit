...
function openModalCrud(id_producto, isValues,id_cat) {
    ...
    if (isValues == "ELIMINAR") {
        ...
        if (isValues == 'CREAR') {
            ...
            $("input[name=check_1]").show();
            $("input[name=check_2]").show();
            $("input[name=check_3]").show();
            $("input[name=check_4]").show();
        ...
        if (id_producto) {
            ...
            $("input[name=check_1]").hide();
            $("input[name=check_2]").hide();
            $("input[name=check_3]").hide();
            $("input[name=check_4]").hide();
