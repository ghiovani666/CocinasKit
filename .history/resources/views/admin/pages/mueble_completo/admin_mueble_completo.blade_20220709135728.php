                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-6">
                                            <div class="col-12">
                                                ...
                                                <div><input type="radio" name="txt_radio_cp" value="1" /> Si</div>
                                                <div><input type="radio" name="txt_radio_cp" value="2" /> No</div>

                                                <div class="col-12" style="margin-top: 10px" id="txt_radio_1">
                                                    <label for="lbl_name">Seleccione la opcion del mueble</label>
                                                ...
                                                <div class="col-12" style="margin-top: 10px" id="txt_radio_2">
                                                    <label for="lbl_name">Escribe la nueva
                                                        opcion del mueble:</label>
                                                    <input type="text" class="form-control" name="txt_mueble_2" id="txt_mueble_2" required />
                                                </div>
...
$('input[name=txt_radio_cp]').on('change', function(e) {
    let id = e.target.value;
    if (id == 1)
        $('select[name=txt_mueble_1]').hide();
    else
        $('input[name=txt_mueble_2]').show();
