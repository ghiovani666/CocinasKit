<div class="col-12" style="display: flex;margin-top: 12px;">
    ...
    <label for="lbl_name" class="check_1" style="margin-left: 20px;margin-top: 2px;">Todos:</label>
    <input type="checkbox" class="check_1" id="check_1" name="check_1" style="width: 17px;height: 33px;margin-left: 10px;" value="1">
</div>
...
<div class="col-12" style="display: flex;margin-top: 12px;">
    ...
    <label for="lbl_name" class="check_2" style="margin-left: 20px;margin-top: 2px;">Todos:</label>
    <input type="checkbox" class="check_2" id="check_2" name="check_2" style="width: 17px;height: 33px;margin-left: 10px;" value="2">
</div>
<div class="btn-group btn-group-toggle" data-toggle="buttons">
    <div class="select2-purple">
...
<div class="col-12" style="display: flex;margin-top: 12px;">
    ...
    <label for="lbl_name" class="check_3" style="margin-left: 20px;margin-top: 2px;">Todos:</label>
    <input type="checkbox" class="check_3" id="check_3" name="check_3" style="width: 17px;height: 33px;margin-left: 10px;" value="3">
</div>
<div class="btn-group btn-group-toggle" data-toggle="buttons">
    <div class="select2-purple">
...
<div class="col-12" style="display: flex;margin-top: 12px;">
    ...
    <label for="lbl_name" class="check_4" style="margin-left: 20px;margin-top: 2px;">Todos:</label>
    <input type="checkbox" class="check_4" id="check_4" name="check_4" style="width: 17px;height: 33px;margin-left: 10px;" value="4">
</div>
<div class="btn-group btn-group-toggle" data-toggle="buttons">
    <div class="select2-purple">
