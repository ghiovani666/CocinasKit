                ...
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                    <div class="select2-purple">
                        <select name="nameColor[]" multiple
                            ...
                            <option value="{{ $items->id  }}" id_producto="{{ $rows->id_producto }}" id_modelo_puerta="{{ $rows->id_modelo_puerta }}"
...
$(function() {
    ...
    $(".nameColor").on("select2:select", function(e) {
        ...
        var select_val0 = $(e.currentTarget).val();
        var select_val1 = $(e.currentTarget)[0][0].attributes.id_producto.nodeValue;
        var select_val2 = $(e.currentTarget)[0][0].attributes.id_modelo_puerta.nodeValue;


        console.log(select_val0)
        console.log(select_val1)
        console.log(select_val2)
