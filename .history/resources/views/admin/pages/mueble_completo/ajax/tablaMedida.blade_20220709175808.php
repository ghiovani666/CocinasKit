<table id="example1" class="table table-bordered table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $rows->alto }} cm</td>
            <td>{{ $rows->fondo }} cm</td>
            <td>{{ $rows->apert_izquierda=='1'? <i class="fas fa-check"></i>:<i class="fas fa-times"></i> }} <i class="fas fa-check"></i></td>
            <td>{{ $rows->apert_derecha=='1'? <i class="fas fa-check"></i>:<i class="fas fa-times"></i> }} <i class="fas fa-check"></i></td>
            <td>{{ $rows->apert_doble=='1'? <i class="fas fa-check"></i>:<i class="fas fa-times"></i> }} <i class="fas fa-check"></i></td>
