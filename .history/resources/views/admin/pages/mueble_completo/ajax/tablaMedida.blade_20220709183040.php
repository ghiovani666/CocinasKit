    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="display: flex;">
                <a href="#" onclick="openModalMedidas({{ $rows->id_medida }},'EDITAR')" class="btn btn-badge"><i class="fas fa-edit"></i></a>
                <a  href="#" onclick="openModalMedidas({{ $rows->id_medida }},'ELIMINAR')" class="btn btn-badge"><i class="fas fa-trash-alt"></i></a>
            </td>
        </tr>
        @endforeach
    </tbody>
