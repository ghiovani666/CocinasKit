...
<?php $colorCount++;
  ...
  'created_at' => date("Y-m-d H:i:s"),'updated_at' =>date("Y-m-d H:i:s")]
    ...
    //----------------CAMBIO DE APERTURA
//    public function change_apertura(Request $request)
//    {

//           $txt_id_color = $request->txt_id_color;
//           $txt_id_product = $request->txt_id_product;
//           $txt_apertura = $request->txt_apertura;
//           //dd($txt_id_color);
//         //  dd($txt_apertura);
//         //   exit();
//           $Medida = DB::table('imagen as i')
//                        ->join('medida as m', 'i.id_medida', '=', 'm.id_medida')
//                        ->join('apertura as a', 'm.apertura', '=', 'a.id')
//                        ->select(DB::raw('DISTINCT(m.apertura) AS apertura'),'m.id_color','i.id_product','a.names')
//                       // ->select(DB::raw('CONCAT(m.ancho,m.unidad) as ancho'),DB::raw('CONCAT(m.alto,m.unidad) as alto'),DB::raw('CONCAT(m.fondo,m.unidad) as fondo'),'m.id_medida','m.id_color','i.id_product','m.apertura')
//                        ->where('m.id_color', $txt_id_color)
//                        ->where('i.id_product', $txt_id_product)
//                        ->get();
//           // return view('web.pages.images.change_apertura', compact('Medida'));

           
//          return view('web.pages.images.change_apertura')
//          ->with(compact('Medida'))
//         ->with(compact('txt_apertura'));

//    }

    //----------------CAMBIO DE FICHA
//    public function change_ficha(Request $request)
//    {

//     if($request->txt_valor){
//         $Medida = DB::table('products')
//         ->join('imagen', 'products.id', '=', 'imagen.id_product')
//         ->join('medida', 'imagen.id_medida', '=', 'medida.id_medida')
//         ->join('color_image', 'medida.id_color', '=', 'color_image.id')

//         ->select(
//             DB::raw('CONCAT(medida.ancho,medida.unidad) as ancho'),
//             DB::raw('CONCAT(medida.alto,medida.unidad) as alto'),
//             DB::raw('CONCAT(medida.fondo,medida.unidad) as fondo'),
//             'products.pro_name',
//             'color_image.name_color',
//             'products.pro_info'
//             )
//         ->where('medida.id_medida',$request->txt_id_medida)
//         ->get();
//     }else{
//         $Medida = DB::table('products')
//         ->join('imagen', 'products.id', '=', 'imagen.id_product')
...
//             'products.pro_info'
//             )
//         ->where('medida.id_color', $request->txt_id_color)
//         ->where('imagen.id_product', $request->txt_id_product)
//         ->get();
//     }
      
//            return view('web.pages.images.change_ficha', compact('Medida'));
//    }
