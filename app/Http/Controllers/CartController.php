...
class CartController extends Controller
{
    public function index(){
        $cartItems = Cart::content();
         return view('web.pages.cart.index', compact('cartItems'));
    ...
    public function addItem(Request $request,$id){
       ...
       // Cart::add($id,$products->pro_name,2,$price,['datos'=>$datas,'img' => $products->pro_img,'stock' => $products->stock]);
        Cart::add($id,$products[0]->pro_name,$cantidad,$request->costo_total,['datos'=>$datas,'id_imagen' => $request->id_imagens,'img' => $products[0]->url_image]);
    ...
    public function update(Request $request, $id)
    {
           ...
           $rowId = $request->rowId;
            ...
            return view('web.pages.cart.upCart', compact('cartItems'))->with('status', 'cart updated');
    }
}